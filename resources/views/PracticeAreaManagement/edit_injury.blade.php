...
<nav style="font-size:15px;">
    ...
    <a href="#" style="color: #1D1D50;">Edit Personal Injury</a>
</nav>
<br><br>
<div class="container" >
    <div class="py-5">
        ...
        <div>
            ...
            <div >
            {{-- heading --}}
    <h4 id="hdtpa"><b>Edit Injury</b></h4>
    <br><br>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="matter_info" id="age" value="{{$edit->matter_info}}">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="matter_type" id="age" value="{{$edit->matter_type}}">
                                <!-- <select name="box_type" id="cars">
                                <option>select</option>
                                                            <option>Box Type 1</option>
                                                            <option>Box Type 2</option>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="incident" id="age" value="{{$edit->incident}}">
                                <!-- <select name="box_type" id="cars">
                                <option>select</option>
                                                            <option>Box Type 1</option>
                                                            <option>Box Type 2</option>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="damage" id="age" value="{{$edit->damage}}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="insurer" id="age" value="{{$edit->insurer}}">
                                <!-- <select name="box_type" id="cars">
                                <option>select</option>
                                                            <option>Box Type 1</option>
                                                            <option>Box Type 2</option>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="policy_detail" id="age" value="{{$edit->policy_detail}}">
                                <!-- <select name="box_type" id="cars">
                                <option>select</option>
                                                            <option>Box Type 1</option>
                                                            <option>Box Type 2</option>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="defendent" id="age" value="{{$edit->defendent}}">
                                <!-- <select name="box_type" id="cars">
                                <option>select</option>
                                                            <option>Box Type 1</option>
                                                            <option>Box Type 2</option>
