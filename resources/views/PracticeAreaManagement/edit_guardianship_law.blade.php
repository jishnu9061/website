...
<nav style="font-size:15px;">
    ...
    <a href="#" style="color: #1D1D50;">Edit Guardianship Law</a>
</nav>
<br><br>
{{-- heading --}}
<div class="container">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea class="form-control" rows="2"
                                        name="attroney">{{$edit->attroney}}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend"></div>
                                    <textarea class="form-control" rows="2"
                                        name="disadility_details">{{$edit->disadility_details}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend"></div>
                                    <textarea class="form-control" rows="2"
                                        name="guardian_details">{{$edit->guardian_details}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
