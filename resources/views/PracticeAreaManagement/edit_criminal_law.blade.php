                ...
                <div class="col-md-4">
                    <div class="mb-1">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="" name="defendent" value="{{$edit->defendent}}">
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="mb-1">
                        ...
                        <div class="input-group">
                            ...
                            <textarea class="form-control" rows="2" name="prosecutor">{{$edit->prosecutor}}</textarea>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="mb-1">
                        ...
                        <div class="input-group">
                            ...
                            <textarea class="form-control" rows="2" name="investigator">{{$edit->investigator}}</textarea>
                        </div>
                    </div>
                </div>
            </div>
