...
@section('content')
    <div class="container">
        {{-- heading --}}
        <h4 id="hdtpa"><b>Manage Groups</b></h4><br>
        <!---------------------------------------------- MODAL ---------------------------------------------------------------------->
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                ...
                <div class="header_wrap">
                                ...
                                @foreach ($user_group as $group)
                                    <tr>
                                        ...
                                        <td scope="row"class="text-center">
                                            <a href="{{ url('edit_new_user_grp', $group->id) }}"><i
                                                    style="  color:rgb(13, 1, 56);padding-left:10px" class="fa fa-edit"
                                                    aria-hidden="true"></i>
                                                <span class="m-1"></span>
                                            <a href="#" data-toggle="modal" data-id="{{ $group->id }}"
                                                        data-name="{{ $group->group_name }}"onclick="deletegroup(this)"
                                                        data-target="#deletegroup"> <i
                    ...
                    <div class="modal fade" id="deletegroup" style="">
                        <!-- delete company -->
                        <div class="modal-dialog modal-lg" style="width:30%;">
                            <div class="modal-content">
                                <!---- Modal Header -->
                                <form method="post" id="delete_group" action="#" enctype="multipart/form-data">
                                    @csrf
                                    <input type="hidden" id="deleteid" value="id">
                                    <div class="modal-header" style="padding:0rem 0rem;">
                                        <div style="padding:1rem 1rem;">
                                            <h4 class="text-centre"><b>Delete <span id="deletgroup_name"></span></b>
                                            </h4>
                                        </div>
                                    </div>
                                    <!-- Modal body -->
    ...
    <script>
        function deletegroup(param) { // delete group 
            var deleteid = $(param).data('id');
            var deletegroup_name = $(param).data('group_name');
            $('#deleteid').val(deleteid);
            $('#deletgroup_name').html(deleterole_name);
            document.getElementById("deleterole_name").innerHTML = deletegroup_name;
            $('#delete_role').attr('action', "{{ url('user_group_destroy')}}" + "/" + deleteid);
        }
    </script>
@endsection
