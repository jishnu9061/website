        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                ...
                <div class="header_wrap">
                                                    ...
                                                    <div class="mb-1">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="password" class="form-control"
                                                                name="re_type_password" id="" value=""
                                                                required>
                                                            <div class="invalid-feedback" style="width: 100%;">
                                                                Name is required.
                                                            </div>
                                                    ...
                                                    <div class="mb-1">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="file" class="form-control"
                                                                name="upload_signature" id="" value=""
                                                                required>
                                                            <div class="invalid-feedback" style="width: 100%;">
                                                                Name is required.
                                                            </div>
                    ...
                    <div class="modal fade" id="deleteuser" style="">
                        <!-- delete company -->
                        <div class="modal-dialog modal-lg" style="width:30%;">
                            <div class="modal-content">
                                <!---- Modal Header -->
                                <form method="post" id="delete_user" action="#" enctype="multipart/form-data">
                                    @csrf
                                    <input type="hidden" id="deleteid" value="id">
                                    <div class="modal-header" style="padding:0rem 0rem;">
                                        <div style="padding:1rem 1rem;">
                                            <h4 class="text-centre"><b>Delete <span id="deletuser_name"></span></b>
                                            </h4>
                                        </div>
                                    </div>
                                    <!-- Modal body -->
                ...
                <script>
                    function deleteuser(param) { // delete user 
                        var deleteid = $(param).data('id');
                        var deleteuser_name = $(param).data('name');
                        $('#deleteid').val(deleteid);
                        $('#deletuser_name').html(deleteuser_name);
                        document.getElementById("deleteuser_name").innerHTML = deleteuser_name;
                        $('#delete_user').attr('action', "{{ url('user_destroy') }}" + "/" + deleteid);
                    }
                </script>
            @endsection
