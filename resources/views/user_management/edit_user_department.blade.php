...
<nav style="font-size:15px;">
      ...
      <a href="{{url('manage_user_department')}}" style="color: #1D1D50;">Manage User Department</a> /
      <a href="#" style="color: #1D1D50;">Edit User Department</a>
</nav>
<br><br>
<div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-1">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="department_code" id=""
                                            value="{{$edit_department->department_code}}">
                            ...
                            <div class="col-md-6">
                                <div class="mb-1">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend"></div>
                                        <input type="text" class="form-control" name="department_name" id="username"
                                            value="{{$edit_department->department_name}}">
                                        <div class="invalid-feedback" style="width: 100%;">
                                            Name is required.
                                        </div>
                                    </div>
