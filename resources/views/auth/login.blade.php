...
<style>
    ...
    .body_back{
        ...
        background-image: linear-gradient(to right top, #1d1d50, #5e315e, #8f4e68, #b67374, #d49d86, #d9b693, #ddcea8, #e1e5c2, #daebd3, #dcefe3, #e4f1ee, #f1f3f3);
        ...
        <div class="row" >
            <div class="col-lg-6 " style="padding: 80px;">
                <div style=" background-color:#ffffff; border-radius:30px; width:30rem; margin: auto">
                    <div id="auth-left">
                        <div class="auth-logo ">
                            <img class="mx-auto d-block" id="cr_logo" src="assets/images/Logo cra.png" alt=""
                                style="width:6rem;height:6rem; ">
                        </div>

                        <div class="" style="text-align: center">
                            <h5 style="font-size: 200%" class="auth-title">Log in</h5>
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group position-relative has-icon-left mb-4">
                                ...
                                <input id="email" type="number" class="form-control form-control-xl"
                                    placeholder="Employee Id" name="email" value="" required
                            ...
                            <div class="form-check form-check-lg d-flex align-items-end">
                                <input class="form-check-input me-2" type="checkbox" value=""
                                    id="flexCheckDefault" style="margin-top: 0px">
                            ...
                            <button type="submit" class="btn btn-primary btn-block btn-lg  mt-3"
                                style="margin: 0px; border: 1px solid #1D1D50;">
                                {{ __('Login') }}
                            </button>
                        </form>
                        <div class="text-center mt-1 text-lg" style="font-size: 18px">
                            <p class="text-gray-600">Don't have an account? <br> <a href="auth-register.html"
            ...
            <div class="align-items-center col-lg-6 d-flex justify-content-center">
                <img id="auth-right" src="assets/images/bg/loginimage.jpg" style="border-radius: 50px; "
