...
<nav style="font-size:15px;">
    ...
    <a href="{{url('follow-up')}}" style="color: #1D1D50;">Client Follow-up</a> /
    <a href="#" style="color: #1D1D50;">Edit Follow-up</a>
</nav>
<br><br>
    {{-- heading --}}
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-1">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend"></div>
                                        <input type="text" class="form-control" name="Alert" id="age"
                                            value="{{ $edit_follow->alert_period }}" placeholder="" min="0" max="99">
                                        <div class="invalid-feedback" style="width: 100%;">
                                            Alert is required.
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-1">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend"></div>
                                        <input type="email" class="form-control" name="email" value="{{ $edit_follow->email }}"
                                ...
                                <div class="mb-1">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="Registered"
                                            value="{{ $edit_follow->registered_by }}" id="password" placeholder="">
                                        <div class="invalid-feedback" style="width: 100%;">
                                            Email is required.
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm">
                                    ...
                                    <button type="button" class="btn btn-primary float:left"
                                        Style="width:45%;"onclick="history.back()">Cancel</button>
                                </div>
                            </div>
                        </div>
