                        ...
                        <div class="mb-1">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="number" id="username"
                                    value="{{$edit_client->client_number}}">
                        ...
                        <div class="mb-1">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="incorporation" id="age"
                                    value="{{$edit_client->certificate_of_incorporation}}" min="0" max="99">
                                <div class="invalid-feedback" style="width: 100%;">
                                    Age is required.
                                </div>
                            </div>
                        ...
                        <div class="mb-1">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="telephone"
                                    value="{{$edit_client->telephone_no}}" id="confirm_password">
                                <div class="invalid-feedback" style="width: 100%;">
                        ...
                        <div class="mb-1">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="faxno" id="age"
                                    value="{{$edit_client->fax_no}}" min="0" max="99">
                                <div class="invalid-feedback" style="width: 100%;">
                                    Age is required.
                                </div>
                            </div>
                        ...
                        <div class="mb-1">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" class="form-control" name="email"
                                    value="{{$edit_client->email_address}}" id="password">
                                <div class="invalid-feedback" style="width: 100%;">
                                    Password is required.
                                </div>
                            </div>
                        ...
                        <div class="mb-1">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="narration"
                                    value="{{$edit_client->client_source_narration}}" id="confirm_password">
                                <div class="invalid-feedback" style="width: 100%;">
                                    Password is required.
                                </div>
                            </div>
                        ...
                        <div class="mb-1">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="name"
                                    value="{{$edit_client->client_name}}" id="confirm_password">
                                <div class="invalid-feedback" style="width: 100%;">
                                    Password is required.
                                </div>
                            </div>
                        ...
                        <div class="mb-1">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="pin" id="age"
                                    value="{{$edit_client->pin_no}}" min="0" max="99">
                                <div class="invalid-feedback" style="width: 100%;">
                                    Age is required.
                                </div>
                            </div>
                        ...
                        <div class="mb-1">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="address"
                                    value="{{$edit_client->postal_address}}" id="password">
                                <div class="invalid-feedback" style="width: 100%;">
                                    Password is required.
                                </div>
                            </div>
                        ...
                        <div class="mb-1">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="code"
                                    value="{{$edit_client->postal_code}}" id="confirm_password">
                                <div class="invalid-feedback" style="width: 100%;">
                                    Password is required.
                                </div>
                            </div>
