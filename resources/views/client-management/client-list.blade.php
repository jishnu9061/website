        ...
        <div class="container">
            <button class="btn btn-primary"
                style="width:100%;background-color:#d6ba8a;color:#1D1D50;color;border:1px solid gold;font-width:150%"><span
                    class="font-size-lg"><b>Individual Client List</b></span></button><br>
            <br>
                        ...
                        <tbody>
                            <tr id="data">
                                ...
                                <td scope="row"class="text-center"><a href="{{ url('view-client') }}">
                                        <a href="{{ url('add-document') }}"><button class="btn btn-primary document_btn"
                                                style="width:90%; margin-top:-8px;">Add Documents</button></a></td>
                                <td><a href="{{ url('view-client') }}"><i style="color:black;" class="fa fa-eye"
                                            aria-hidden="true"></i></td></a>
                                <td><a href="{{ url('edit_client') }}"><i style="color:black;" class="fa fa-edit"
                                            aria-hidden="true"></i></td>
                                <td><a href=""><i style="color:black;" class="fa fa-trash" aria-hidden="true"></i>
                                </td>
