            ...
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="new-item">
                        ...
                        <tbody>
                            @foreach($quotation as $list_quotation)
                            <tr id="data">
                                <td scope="row" class="text-center">{{$list_quotation->id}}</td>
                                <td scope="row" class="text-center" id="medicine_name_1">{{$list_quotation->issue_date}}</td>
                                <td scope="row" class="text-center" id="medicine_name_1"></td>
                                <td scope="row" class="text-center" id="medicine_name_1">{{$list_quotation->customer}}</td>
                                <td scope="row" class="text-center" id="medicine_name_1">{{$list_quotation->amount}}</td>
                                <td scope="row" class="text-center" id="medicine_name_1"></td>
                                <td><a href="{{url('edit-Quotation',$list_quotation->id)}}"><i style="color:black;" class="fa fa-edit"
                                                ...
                                                <form method="post" action="{{url('add-Quotation')}}" id="form">
                                                    ...
                                                    <div>
                                                        <div class="btn btn-primary"
                                                            ...
                                                            <b><u> Quotation Items</u></b></span></div><br>
                                                        <link
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="mb-1">
                                                                ...
                                                                <div class="input-group">
                                                                    <div class="input-group-prepend"></div>
                                                                    <input type="text" class="form-control"
                                                                        name="comments" value="" id="password"
                                                                        placeholder="">
                                                                    <div class="invalid-feedback" style="width: 100%;">
                                ...
                                <div class="modal-body">
                                    <div class="container">
                                        <form method="post" action="{{url('update_medicine')}}"
                                            ...
                                            @csrf
                                            <h4 class="text-center"><b>Medicine Details</b>
                                            </h4><br>
                                            <div class="row">
                                                <div class="col-sm">
