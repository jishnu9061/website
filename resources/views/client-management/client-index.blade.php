...
<div class="container-fluid">
  ...
  <div class="col-sm-4 " > <a><img class="logo_size" src="image\logo\icon-2.png" alt=""><button type="button" class="btn btn-primary btn_align_btn" > Customer follow up</button></a></div>
