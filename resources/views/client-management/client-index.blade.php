       ...
       <br>
        ...
        <div class="row sm">
            ...
            <div class="col-sm-4 "><img class="logo_size" src="image\logo\Client list.png" alt="">
                ...
                <div class="col-sm-4 ">
                    <div class="dropdown    " > <img class="logo_size" src="image\logo\Client list.png" alt=""><button type="button" style="width:70%;" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                        class="btn btn-primary btn_align_btn">Client list</button></a>
                ...
                <div class="col-sm-4 "><img class="logo_size" src="image\logo\Document details.png" alt=""><a
                        href="{{url('client-document')}}"><button type="button"style="width:70%;"class="btn btn-primary btn_align_btn">Document Details</button></a></div>
