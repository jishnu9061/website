...
<nav style="font-size:15px;">
    ...
    <a href="{{url('Quotation')}}" style="color: #1D1D50;">Client Quotation</a> /
    <a href="#" style="color: #1D1D50;">Edit Client Quotation</a>
</nav>
<br><br>
    {{-- heading --}}
                                ...
                                <div class="mb-1">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date" class="form-control" name="issue" id="age"
                                            value="{{ $edit_quotation->issue_date }}" placeholder="corporation" min="0"
                                            max="99">
                                ...
                                <div class="mb-1">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="ref" id="age"
                                            value="{{ $edit_quotation->client_ref_no }}" placeholder="" min="0"
                                            max="99">
                                        <div class="invalid-feedback" style="width: 100%;">
                                            Age is required.
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="username">Particulers Of Service
                                        Rendered</label>
                                    <div class="input-group">
                                        <textarea class="form-control" id="form7Example7" rows="1" name="Rendered"></textarea>
                                        <div class="invalid-feedback" style="width: 100%;">
                                            Postal Address is required.
                                        </div>
                                    </div>
