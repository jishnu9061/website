                            ...
                            <tbody>
                                ...
                                <tr id="data">
                                    ...
                                    <td scope="row" class="text-center">
                                        <a href="{{url('corporate-document',$list->corporate_id)}}"><button class="btn btn-primary"> Add </button></a></td>
                                    <td scope="row" class="text-center" id="medicine_name_1">
                                                        ...
                                                        <div class="mb-1">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    name="Designation" id="age" value="" placeholder=""
                                                                    min="0" max="99">
                                                                <div class="invalid-feedback" style="width: 100%;">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="mb-1">
                                                            ...
                                                            <div class="input-group">
                                                                <div class="input-group-prepend"></div>
                                                                <input type="text" class="form-control"
                                                                    name="person_email" id="age" value="" placeholder=""
                                                                    min="0" max="99">
                                                                <div class="invalid-feedback" style="width: 100%;">
                                                                </div>
                                                                <br>
