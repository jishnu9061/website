            ...
            <form method="post" action="{{url('add-follow')}}" id="form">
                        ...
                        <div class="mb-1">
                            ...
                            <div class="input-group">
                                ...
                                <select name="customer" id="cars">
                                    ...
                                    <option >Aggriculture Development Corporation</option>
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="mb-1">
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend"></div>
                                <input type="date" class="form-control" name="Bring" value="" id="password"
                                    placeholder="">
                                <div class="invalid-feedback" style="width: 100%;">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="mb-1">
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend"></div>
                                <input type="text" class="form-control" name="Alert" id="age" value="" placeholder=""
                                    min="0" max="99">
                                <div class="invalid-feedback" style="width: 100%;">
                                    Alert is required.
                                </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-1">
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend"></div>
                                <input type="text" class="form-control" name="Registered" value="" id="password"
                                    placeholder="">
                                <div class="invalid-feedback" style="width: 100%;">
                                    Email is required.
                                </div>
                ...
                <!-- <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm">
                            <button type="submit" class="btn btn-primary submit_btn btn_sumbit">Update </button>
