    ...
    <div class="row">
        <div class="col-md-12 order-md-1">
            <form method="post" action="" id="form">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="mb-1">
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend"></div>
                                <input type="text" class="form-control" name="Address" id="username" value=""
                                    placeholder="" required>
                                <div class="invalid-feedback" style="width: 100%;">
                                    Address is required.
                                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-1">
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend"></div>
                                <input type="email" class="form-control" name="Website" value="" id="password"
                                    placeholder="">
                                <div class="invalid-feedback" style="width: 100%;">
                ...
                <br>
                <h4 style="text-align:center; ">Contact Person</h4>
                <br>
                <div class="row">
                    <div class="col-md-3">
                        <div class="mb-1">
