...
<nav style="font-size:12px;">
      ...
      <a href="#" style="color: #1D1D50;">Client Management-Edit Corporate Client</a>
</nav>
<br><br>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="mb-1">
                        ...
                        <div class="input-group">
                            <div class="input-group-prepend"></div>
                            <input type="text" class="form-control" name="name" value="{{$corporate_details->client_name}}"
                                id="confirm_password">
                            <div class="invalid-feedback" style="width: 100%;">
                                Password is required.
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="mb-1">
                        ...
                        <div class="input-group">
                            <div class="input-group-prepend"></div>
                            <input type="text" class="form-control" name="code" value="{{$corporate_details->postal_code}}"
                                id="confirm_password">
                            <div class="invalid-feedback" style="width: 100%;">
                                Password is required.
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="mb-1">
                        ...
                        <div class="input-group">
                            <textarea class="form-control" id="form7Example7" rows="3"
                                name="notes">{{$corporate_details->physical_address}}</textarea>
                            <div class="invalid-feedback" style="width: 100%;">
                                Postal Address is required.
                            </div>
                        </div>
