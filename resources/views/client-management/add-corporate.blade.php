    ...
    <div class="container">
            ...
            <div>
                <button class="btn btn-primary"
                    style="width:100%;background-color:#d6ba8a;color:#1D1D50;border:1px solid gold;font-width:150%"><span
                        class="font-size-lg"><b>Add New Corporate Client</b></span></button><br><br>
                <br>
          ...
          <div class="row">
                <form method="post" action="" id="form">
                        ...
                        <div class="col-md-4">
                            <div class="mb-1">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="type" id="cars" placeholder="Corporate" disabled>
                            ...
                            <div class="mb-1">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="corporation" id="age"
                                        value="" placeholder="Certificate" min="0" max="99">
                                    <div class="invalid-feedback" style="width: 100%;">
                                        Age is required.
                                    </div>
                                </div>
                            ...
                            <div class="mb-1">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="faxno" id="age"
                                        value="" placeholder="Fax no" min="0" max="99">
                                    <div class="invalid-feedback" style="width: 100%;">
                                        Age is required.
                                    </div>
                                </div>
                            ...
                            <div class="mb-1">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="name" value=""
                                        id="confirm_password" placeholder="Name">
                                    <div class="invalid-feedback" style="width: 100%;">
                                        Password is required.
                                    </div>
                                </div>
                            ...
                            <div class="mb-1">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="pin" id="age"
                                        value="" placeholder="Pin No" min="0" max="99">
                                    <div class="invalid-feedback" style="width: 100%;">
                                        Age is required.
                                    </div>
                                </div>
                            ...
                            <div class="mb-1">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="code" value=""
                                        id="confirm_password" placeholder="Postal Code">
                                    <div class="invalid-feedback" style="width: 100%;">
                                        Password is required.
                                    </div>
                                </div>
                            ...
                            <div class="mb-1">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="town" id="age"
                                        value="" placeholder="Town" min="0" max="99">
                                    <div class="invalid-feedback" style="width: 100%;">
                                        Age is required.
                                    </div>
                                </div>
                    ...
                    <button class="btn btn-primary"
                    style="width:100%;background-color:#d6ba8a;color:#1D1D50;border:1px solid gold;font-width:150%"><span
                        class="font-size-lg"><b>Contact Person</b></span></button><br><br>
                    <div class="row">
                        <div class="col-md-3">
                            <div class="mb-1">
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm">
                            ...
                            <button type="button" class="btn btn-primary float-right" style="width:50%">Back</button>
                          </div>
                        </div>
                    </div>
                </form>
