                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-class" id="table-id">
                            ...
                            <tbody>
                                ...
                                <tr id="data">
                                    <td scope="row" class="text-center" id="medicine_name_1">{{$list->id}}</td>
                                    <td scope="row" class="text-center" id="medicine_name_1">{{$list->followup_date}}
                                    </td>
                                    <td scope="row" class="text-center" id="medicine_name_1">{{$list->followup_type}}
                                    </td>
                                    <td scope="row" class="text-center" id="medicine_name_1">{{$list->customer}}</td>
                                    <td scope="row" class="text-center" id="medicine_name_1">{{$list->description}}</td>
                                    <td scope="row" class="text-center" id="medicine_name_1">
                                        {{$list->next_bringup_date}}</td>
                                    <td scope="row" class="text-center" id="medicine_name_1">{{$list->alert_period}}
                                    </td>
                                    <td scope="row" class="text-center" id="medicine_name_1">
                                        {{$list->staff_responsible}}</td>
                                    <td scope="row" class="text-center" id="medicine_name_1">{{$list->registered_by}}
                                    </td>
                                    <td><a href="{{url('edit-follow',$list->id)}}"><i style="color:black;"
                                                class="fa fa-edit" aria-hidden="true"></i></a>
