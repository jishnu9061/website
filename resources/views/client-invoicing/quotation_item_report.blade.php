...
<div class="container">
    <div class="py-5 text-center">
        ...
        <div>
            ...
            style="width:100%;background-color:#d6ba8a;color:#1D1D50;border:1px solid gold;font-size:25px;"><b><u>Quotation Item Report</u></b></div><br><br>
        ...
        <div class="col-md-12 order-md-1">
            ...
            <form method="post" action="" id="form">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="mb-1">
                            <label for="username">Quotation Item</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                    ...
                    <div class="col-md-3">
                        <div class="mb-1">
                            <label for="username">Creteria</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
