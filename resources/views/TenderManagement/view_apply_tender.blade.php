                                ...
                                <table class="table">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input class="form-control" type="date" aria-label="input example" name="date"></td>

                                        </tr>
                                        <tr>
                                            <td scope="row">Item Name</td>
                                            <td><input class="form-control" type="text" aria-label="input example" name="item_name"></td>
                                        </tr>
                                        <tr>
                                            <td scope="row">Quantity</td>
                                            <td><input class="form-control" type="text" aria-label="input example" name="Quantity"></td>
                                        </tr>
                                        <tr>
                                            <td scope="row">Supplier Name</td>
                                            <td><input class="form-control" type="text" aria-label="input example" name="supplier_name"></td>
                                        </tr>
                                        <tr>
                                            <td scope="row">Mobile No.</td>
                                            <td><input class="form-control" type="text" aria-label="input example" name="mobile_no"></td>
                                        </tr>
                                        <tr>
                                            <td scope="row">Address</td>
                                            <td><input class="form-control" type="text" aria-label="input example" name="address"></td>
                                        </tr>
                                        <tr>
                                            <td scope="row">Description</td>
                                            <td><textarea class="form-control" rows="2" name="description"></textarea></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><input class="form-control" type="text" aria-label="input example" name="contract"></td>
                                        </tr>
                                        <tr>
                                            <td scope="row">Total Cost of Tender</td>
                                            <td><input class="form-control" type="text" aria-label="input example" name="cost"></td>
                                        </tr>

                                        <tr>
                                            <td scope="row">Payment Type</td>
                                            <td><input class="form-control" type="text" aria-label="input example" name="payment"></td>
                                        </tr>
