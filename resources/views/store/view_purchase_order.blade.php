                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tr>
                                                        {{-- <td scope="col">Grand Total</td> --}}
                                                        <td><input type="text" class="form-control invoice-sub-total" value="" name="advance_amount"  readonly></td>
                                                    </tr>
                                                    <tr>
                                                        {{-- <td scope="col">Grand Total</td> --}}
                                                        <td><input type="text" class="form-control invoice-sub-total" value="" name="pending_amount"  readonly></td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </div>
