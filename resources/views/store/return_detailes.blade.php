...
<body>
    <div class="">
        <div class="col-md-12">
            <h3 style="text-align:center"><b><u>Return Details</u></b></h3><br>
          <table id="example1" class="table table-bordered" style="border: 1px solid" >
              <tr>
                <th class="text-center">Purchase Date</th>
                  <td  class="text-center">{{date('d-m-Y',strtotime($purchasedata[0]->purchase_date))}}</td>
              </tr>
              <tr>
                <th  class="text-center">Order Number</th>
                  <td  class="text-center">{{$purchasedata[0]->purchase_orderno}}</td>
              </tr>
              @if ($purchasedata[0]->supplier_name)
              <tr>
                <th  class="text-center">Supplier Name</th>
                  <td  class="text-center">{{$purchasedata[0]->supplier_name}}</td>
              </tr>
              @else
              <tr>
                <th  class="text-center">Manufacturer</th>
                  <td  class="text-center">{{$purchasedata[0]->manufactuers_name}}</td>
              </tr>
              @endif
              <tr>
                <th  class="text-center">Payment Type</th>
                  <td  class="text-center">{{$purchasedata[0]->payment_name}}</td>
              </tr>
                                <tr>
                <th  class="text-center">Return Date</th>
                  <td  class="text-center">{{date('d-m-Y H:i:s',strtotime($purchasedata[0]->purchase_added_date))}}</td>
              </tr>
            </table>
                ...
                <tbody  id="show_data">
                    @foreach ($purchasedata as $row)
                        <tr>
                            ...
                            <td  scope="row"class="text-center"><a  href="{{url('edit_return_detailes'.$row->purchase_items_id)}}" ><i  style="color:#435ebe;" class="fa fa-reply-all" aria-hidden="true"></i></a></td>
                        </tr>
                    @endforeach
                </tbody>
                </table>
