          ...
          <table id="example1" class="table table-bordered table-striped " style="width 100%" >
              <tr>
                <th style="text-align:center">Purchase Date</th>
                  <td style="text-align:center">{{date('d-m-Y',strtotime($purchase_order[0]->purchase_date))}}</td>
              </tr>
              <tr>
                <th style="text-align:center">Order Number</th>
                  <td style="text-align:center">{{$purchase_order[0]->purchase_orderno}}</td>
              </tr>
              @if ($purchase_order[0]->supplier_name)
              <tr>
                <th style="text-align:center">Supplier Name</th>
                  <td style="text-align:center">{{$purchase_order[0]->supplier_name}}</td>
              </tr>
              @else
              <tr>
                <th style="text-align:center">Manufacturer</th>
                  <td style="text-align:center">{{$purchase_order[0]->manufacturer}}</td>
              </tr>
              @endif
              <tr>
                <th style="text-align:center">Payment Type</th>
                  <td style="text-align:center" >{{$purchase_order[0]->payment_name}}</td>
              </tr>
            </table>
          </div>
