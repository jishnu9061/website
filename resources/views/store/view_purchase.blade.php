                                    ...
                                    <div class="row">
                                        <div class="col-sm">
                                            ...
                                            <select class="form-select" aria-label="Default select example"
                                                ...
                                                @foreach ($manufact as $key)
                                                    <option value="{{ $key->id }}">{{ $key->manufactuers_name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-sm">
                                            ...
                                            <input type="text" name="purchase_number" id="purchase_number"
                                                class="form-control"
                                                value="@if (!empty($purc_order->purchase_orderno)) {{ $purc_order->purchase_orderno }}@else{{ strtoupper(uniqid()) }} @endif"><br>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm">
                                            ...
                                            <select class="form-select" aria-label="Default select example"
                                                ...
                                                @foreach ($payment_type as $key1)
                                                    <option value="{{ $key1->payment_id }}">{{ $key1->payment_name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-sm">
                                            ...
                                            <input type="text" value={{ 'Order-Placed' }} name="status"
                                                    ...
                                                    <tr>
                                                        <td><select class="form-select" aria-label="select example"
                                                                ...
                                                                @foreach ($item_name as $row)
                                                                    <option value="{{ $row->id }}">
                                                                        {{ $row->Item_name }}--{{ $row->brand_name }}--{{ $row->category_name }}
                                                                    </option>
                                                                @endforeach
                                                            </select></td>
                                    ...
                                    <div class="modal fade" id="myModal-2">
                                        <div class="modal-dialog modal-xm">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="container">
                                                        <form method="post" action="{{ url('add_advance_payment') }}"
                        ...
                        @foreach ($purc_order as $data)
                            <tr id="data">
                                ...
                                <td scope="row" class="text-center">
                                    {{ date('d-m-Y', strtotime($data->purchase_date)) }}</td>
                                ...
                                <td scope="row" class="text-center" id="sup_name_x">{{ 'Order-Placed' }}</td>
                                <td scope="row"class="text-center"><a
                                        href="{{ url('view_purchase_detailes' . $data->id) }}"><i style="color:#435ebe;"
                                            class="fa fa-eye" aria-hidden="true"></i></td>
                                <td scope="row"class="text-center"><a href="{{ url('print' . $data->id) }}"><i
                ...
                <div class="modal fade" id="myModal-1">
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="container">
                                    <form method="post" action="{{ url('create_purchase_medicine') }}"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-sm">
                                            ...
                                            <div class="col-sm">
                                                ...
                                                <select class="form-select" aria-label="Default select example"
                                                    ...
                                                    <option value="">Select</option>
                                                    @foreach ($supplier as $key2)
                                                        <option value="{{ $key2->id }}">{{ $key2->supplier_name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
