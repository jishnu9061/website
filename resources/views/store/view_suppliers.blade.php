                                ...
                                <form method="post" action="{{ url('suppliers_save') }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            {{-- <select class="form-select contrl searchingBook" name="city" aria-label="Default select example" required>
                                            <option selected>City</option>
                                            <option>Sidhpur</option>
                                            <option >Two</option>
                                            <option>Three</option>
                                        </select><br>
                                        <select class="form-select contrl searchingBook" name="state" aria-label="Default select example"required>
                                            <option selected>State</option>
                                            <option>Gujarath</option>
                                            <option>Tamil Nadu</option>
                                            <option>Kerala</option>
                                        </select><br>
                                        <select class="form-select contrl searchingBook" name="country" aria-label="Default select example" required>
                    ...
                    <tbody>
                        ...
                        @foreach ($suppliers as $data)
                            <tr id="data">
                                ...
                                <td scope="row"class="text-center" id="supplier_mobile">{{ $data->mobile }}</td>
                                <td scope="row"class="text-center"><a
                                        href="{{ url('suppliers_details' . $data->id) }}"><i style="color:#435ebe;"
                                            class="fa fa-eye" aria-hidden="true"></i></td>
                                <input type="hidden" value="{{ $data->id }}" id="sup_id_hidden" class="applicate"
                                    name="supplier_id_hidden">
                                <td class="text-center"><a href="{{ url('upload_suppliers' . $data->id) }}"
                                ...
                                <td class="text-center"><a onClick="return myFunction();"
                                        href="{{ url('delete_suppliers' . $data->id) }}" style="color:#435ebe;"><i
                                            class="fas fa-trash-alt"></i></a></td>
                                <td class="text-center"> <a type="button" class="btn btn-primary" style="width:50%"
                                        href="{{ url('supplier_ledger_details' . $data->id) }}"><b>View</b></a></td>
                                <input type="hidden" id="sup_email" value="{{ $data->email }}">
                                <input type="hidden" id="sup_phone" value="{{ $data->contact_no }}">
                                <input type="hidden" id="sup_mobile" value="{{ $data->mobile }}">
                                <input type="hidden" id="sup_fax" value="{{ $data->fax }}">
                                <input type="hidden" id="sup_address" value="{{ $data->address }}">
                                <input type="hidden" id="sup_city" value="{{ $data->city }}">
                                <input type="hidden" id="sup_state" value="{{ $data->state }}">
                                <input type="hidden" id="sup_country" value="{{ $data->country }}">
                                <input type="hidden" id="sup_postal_code" value="{{ $data->zipcode }}">
                                <input type="hidden" id="sup_detailss" value="{{ $data->details }}">
                            </tr>
                        @endforeach
                    </tbody>
                </table>
                ...
                <div class="modal fade" id="edit" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <form method="POST" enctype="multipart/form-data" action="{{ url('upload_suppliers') }}">
                                @csrf
                                <div class="modal-body">
                                    <div class="container">
                                        <div class="row">
