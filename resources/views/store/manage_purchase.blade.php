...
<body>
    ...
    <div class="container">
        <h3 style="text-align:center"><b><u>Received Order Details</u></b></h3><br>
                ...
                <tbody>
                    @foreach($purc_order as $data)
                        <tr id="data">
                            ...
                            <td  scope="row"class="text-center"><a href="{{url('view_purchase_detailes'.$data->id)}}"><i  style="color:#435ebe;" class="fa fa-eye" aria-hidden="true"></i></td>
