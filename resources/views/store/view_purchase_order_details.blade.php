...
<body>
    <div class="container">
       ...
       <button type="button" class="btn btn-primary" style="background-color:#607080;width:18%;"data-toggle="modal" data-target="#myModal"><b>Add New Purchase</b></button>
       <button type="button" class="btn btn-primary" style="background-color:#607080;width:15%;"data-toggle="modal" data-target="#myModal-1"><b>Add New Item</b></button>
       <br><br>
                            ...
                            <div class="col-sm">
                                ...
                                <select class="form-select" aria-label="Default select example" name="manufacturer">
                                    ...
                                    @foreach($purchase_order as $key)
                                        <option value="{{$key->id}}">{{$key->manufacturer}}</option>
                                    @endforeach
                                  </select>
                            </div>
                            <div class="col-sm">
                            ...
                            <div class="col-sm">
                                <label for="">Payment Type</label>
                                        <select class="form-select" aria-label="Default select example" id="payment_type" name="payment_type" required>
                                            <option value="">Select</option>
                                            @foreach ($purchase_order as $key1)
                                             <option value="{{$key1->payment_id}}">{{$key1->payment_type}}</option>
                                            @endforeach
                                        </select>
                            </div>
                            <div class="col-sm">
                                <label for="">Supplier</label>
                                        <select class="form-select" aria-label="Default select example" name="supplier" id="supplier">
                                            <option value="">Select</option>
                                            @foreach ($purchase_order as $key2)
                                             <option value="{{$key2->id}}">{{$key2->supplier}}</option>
                                            @endforeach
                                        </select>
                            </div>
                            <div class="col-sm">
                                            ...
                                            <form method="post" action="{{url('add_advance_pyment')}}" enctype="multipart/form-data">
                                                ...
                                                @csrf
                                                    <div class="col-sm">
                                                        ...
                                                        <input type="text" name="advance_amount" value="{{0}}" class="form-control" placeholder="Advance Amount"><br>
            ...
            <table class="table table-bordered" id="allsupplier">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">View</th>
                        <th class="text-center">Print Order</th>
                ...
                <tbody>
                    @foreach($purchase_order as $data)
                         <tr id="data">
                            ...
                            <td  scope="row"class="text-center"><a href="{{url('show_purchase_detailes'.$data->id)}}"><i  style="color:#435ebe;" class="fa fa-eye" aria-hidden="true"></i></td>
                            <td  scope="row"class="text-center"><a href="{{url('print'.$data->id)}}"><i  style="color:#435ebe;" class="fa fa-print" aria-hidden="true"></i></td>
                            ...
                            <td  scope="row"class="text-center"><a href="{{url('edit_purchase_detailes'.$data->id)}}"><i  style="color:#435ebe;" class="fa fa-edit" aria-hidden="true"></i></td> --}}
                ...
                <div class="row">
                    ...
                    <div class="col-sm">
                        ...
                        <select class="form-select" aria-label="Default select example" name="manufacture_name">
                            <option value="">Select</option>
                            @foreach($purchase_order as $key)
                                <option value="{{$key->id}}">{{$key->manufactuer}}</option>
                            @endforeach
                          </select>
                    </div>
                    <div class="col-sm">
