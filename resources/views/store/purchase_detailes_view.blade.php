                                  ...
                                  <tr>
                                    ...
                                    <td style="width:20%"><select class="form-control" aria-label="Default select example" name="manufacturer" disabled>
                                        ...
                                        @foreach($manufact as $key)
                                            <option value="{{$key->id}}" {{($key->id == $data->id) ? "selected" : "" }} > {{$key->manufactuers_name}}</option>
                                        @endforeach
                                      </select></td>
                                    <td style="width:20%"> <input type="date" name="purchase_date"  value="{{$data->purchase_date}}"class="form-control" readonly></td>
                                    <td style="width:20%"><input type="text" name="purchase_number" value="{{$data->purchase_orderno}}" class="form-control" style="pointer-events: none;" readonly></td>
                                  </tr>
                                  <tr>
                                    <thead>
                                        <tr>
                                  ...
                                  <tr>
                                    ...
                                    <td scope="col"><select class="form-select" aria-label="Default select example" name="supplier" disabled>
                                        ...
                                        @foreach($supplier as $key)
                                            <option value="{{$key->id}}" {{ ($key->id == $data->id) ? "selected" : "" }} > {{$key->supplier_name}}</option>
                                        @endforeach
                                      </select></td>
                                  ...
                                  <tr>
                                    ...
                                    <input type="hidden" name="item_id[]" value="{{ $row->id}}"class="form-control">
                                        <tr>
                                            ...
                                            <td><input type="text" name="batch_no[]" id="batch_no" class="form-control" value="{{$row->batch_no}}" disabled></td>
                                            <td><input type="text" name="quantity[]" id="quantity" class="form-control  calculate"  value="{{$row->quantity}}" disabled></td>
                                            <td><input type="text" name="price[]" id="price" class="form-control calculate"  value="{{$row->price}}" disabled></td>
                                            <td><input type="text" name="total[]" id="total" class="form-control calculate-sub" value="{{$row->total}}" disabled></td>
                                        </tr>
                                    @endforeach
                                ...
                                <div class="col-sm">
                                    <table class="table table-bordered">
                                          ...
                                          {{-- <tr>
                                            ...
                                            <td><input type="text" class="form-control" name="pending_amount" value="{{0}}" id="result" readonly></td>
                                          </tr>
                                          <tr>
                                            <td scope="col">Repayment Date</td>
                                            <td><input type="date" class="form-control" name="pending_amount" value="<?php echo ($data->grand_total)-($data->advance_amount);?>" id="result" readonly></td>
                                          </tr> --}}
