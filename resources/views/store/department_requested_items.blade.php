            ...
            <table id="example1" class="table table-bordered table-striped" style="width 100%">
              <thead>
                ...
                <tbody  id="show_data">
                  ...
                  <input type="hidden" name="purchase_id" value="{{$row->request_intendid}}" class="form-control">
                    <tr>
                      <td  class="text-center">{{$row->Item_name}}</td>
                      <td  class="text-center">{{$row->requested_quantity}}</td>
                      <td  scope="row"class="text-center"> <a type="button"  href="{{url('store_issued_items'.$row->medicine)}}"class="btn btn-primary" style="background-color:#1a3c62;width:100%;">Issue</a></td>
                    </tr>
                  @endforeach
                </tbody>
            </table>
