                ...
                <tbody>
                    @foreach($requested_items as $data)
                         <tr id="data">
                            ...
                            <td scope="row"><a href="{{url('view_request_details'.$data->request_intendid)}}"><i  style="color:#607080" class="fa fa-arrow-right" aria-hidden="true"></i></td>
                            {{-- <td><a href="{{url('issue_request'.$data->request_intendid )}}"><i  style="color:#607080" class="fa fa-arrow-right" aria-hidden="true"></i></td> --}}
                            {{-- <td  scope="row"class="text-center"><a href="{{url('view_request_details'.$data->request_intendid)}}"><i  style="color:#435ebe;" class="fa fa-eye" aria-hidden="true"></i></td>
