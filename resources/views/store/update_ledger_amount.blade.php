...
<div class="container">
    ...
    {{-- {{$hospital=Auth::user()->id}} --}}
            @foreach ($ledger_details as $row) {{-- <table class="table table-bordered" style="border: 1px solid"> --}}
            <form action="{{url('add_installment'.$row->purchase_id)}}" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden"  name="id" value="{{$row->id}}">
                        ...
                        <div style="width:60%; margin:0 auto;">
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="col-sm-12">
                                            ...
                                            <input type="hidden" class="form-control" name="amount" id="pending-amount" value="{{$row->pending_amount}}">
                                     </div>
                                    <div class="col-sm-12">
                                        <label>Amount</label>
                                     ...
                                     <div class="col-sm-12">
                                        <label>Balance Amount</label>
                                            <input type="text" class="form-control" name="pending_amount" id="result" value="{{$row->pending_amount}}">
                                            </div>
                                <div class="col-sm-12">
                            ...
                            <div class="modal-footer">
                                ...
                                <a type="button" class="btn btn-primary" style="background-color:#607080;width:20%;" href="{{url('manufacturer_ledger_details'.$row->id)}}">Close</a>
