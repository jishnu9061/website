...
<body>
    ...
    <div class="container">
        ...
        <a href="{{url('add_billable_activities')}}"><button class="btn btn-primary add-btn"
                style="width: 20%; margin-bottom:5%;">Add Activity</button></a>
                ...
                <table class="table table-bordered" id="new-item">
                    ...
                    <tbody>
                        <tr id="data">
                            ...
                            <td scope="row" class="text-center"></td>
                            <td scope="row" class="text-center"></td>
                            <td scope="row" class="text-center"> <a href="{{url('edit_billable_activities')}}">Edit</a> </td>
