...
/* td:nth-child(odd) {
   ...
   <body>
    ...
    <h2 style="text-align:center; text-shadow: 2px 1px;">Leave Days Per Year</h2>
        <a href="{{('add_leave_days')}}"><button class="btn btn-primary add-btn"style="width=100%;height=100%;">Add New Entry</button></a>
        <hr class="mb-4">.
        
    <h3 style="color:rgb(13, 1, 56);font-size:large;font-weight:bold;text-align:center;">Leave Days Per Year</h3>
    <!-- <div class="container"> -->
    <div class="table-responsive"> 
      <table class="table table-bordered" id="new-item">
                  <thead>
                        ...
                        <th class="text-center" >Paye Relief</th>
...
<thead>
    <tbody>
                    <tr>
                        ...
                        <td  class="text-center" style="color:rgb(13, 1, 56);"></td>
                        <td  class="text-center" style="color:rgb(13, 1, 56);"></td>
                        <td  class="text-center" style="background-color:white;color:rgb(13, 1, 56);"><a href="{{url('edit_leave_days')}}">Edit</a></td>
