    ...
    <div class="container">
        ...
        <div>
            <div class="btn btn-primary"
                style="width:100%;background-color:#d6ba8a;color:#1D1D50;border:1px solid gold;font-size:25px"><b><u>Leave Days Per Year</u></b></span></div><br>
        ...
        <a href="{{url('add_leave_days')}}"><button class="btn btn-primary add-btn"
                style="width: 20%; margin-bottom:5%;">Add Leave Days</button></a>
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">

            <h5 style="text-align:center; ">Leave Days Per Year</h5>
                ...
                <table class="table table-bordered" id="new-item">
                    ...
                    <tbody>
                        <tr id="data">
                            ...
                            <td scope="row" class="text-center"></td>
                            <td scope="row" class="text-center"></td>
                            <td scope="row" class="text-center"> <a href="{{url('edit_leave_days')}}">Edit</a> </td>
                ...
                <label>Action:</label>
                <select style="width:20%;height:28px;color:white;font-size:small;background-color:#1D1D50;" type="text" value="" name="type">
    <option>Delete Leave Days</option>


</select>
<input type="button"value="Go" name="close"style="background-color:#1D1D50;color: white; ">
    </div>
    <br>
    <br>
    </div>
