...
/* td:nth-child(odd) {
   ...
   <body>
    ...
    <h2 style="text-align:center; text-shadow: 2px 1px;">Paired Accounts</h2>
        <a href="{{('add_account_pairs')}}"><button class="btn btn-primary add-btn"style="width=100%;height=100%;">Add Account Pair</button></a>
        <hr class="mb-4">.
