    ...
    <div class="container">
        ...
        <div>
            <div class="btn btn-primary"
                style="width:100%;background-color:#d6ba8a;color:#1D1D50;border:1px solid gold;font-size:25px"><b><u>Hourly Rates</u></b></span></div><br>
        ...
        <a href="{{url('add_hourly_rates')}}"><button class="btn btn-primary add-btn"
                style="width: 25%; margin-bottom:5%;">Add User Hourly Rates</button></a>
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">

            <h5 style="text-align:center; ">Hourly Rates</h5>
                ...
                <table class="table table-bordered" id="new-item">
                    ...
                    <tbody>
                        <tr id="data">
                            ...
                            <td scope="row" class="text-center"></td>
                            <td scope="row" class="text-center"></td>
                            <td scope="row" class="text-center"> <a href= "{{url('edit_hourly_rates')}}">Edit</a> </td>
