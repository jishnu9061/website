...
@section('content')
 ...
 <!-- 		End of Container --> --}}
    ...
    <input type="button"value="Go" name="close"style="background-color:#FFFBF4;color: rgb(13, 1, 56); ">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-1">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <select type="text" value="" id=""
                                                                name="temcategory"style="width:100%;">
            ...
            <a href="{{ url('document_template_category') }}"> <i style="font-size:20px; color:rgb(13, 1, 56);" class="bi bi-plus-circle-fill"> </i></a>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-1">
                                                        ...
                                                        <div class="input-group">
                                                            <div class="input-group-prepend"></div>
                                                            <input type="text" class="form-control" name="cattype"
                                                                id="" value="">
                                                            <div class="invalid-feedback" style="width: 100%;">
                                                                Required Field.
                                                            </div>
                                        ...
                                        <div class="" style="width: 33%">
                                            <div class=""><span style="color: red">*</span>
                                                <label for="template_category"
                                                    style="width: 100px;margin-bottom: 0px;margin-right: 2px;font-size:10px;">Template
                                                    Category
                                                </label>
                                                <div class="input-group">
                                                    <div class="input-group-prepend"></div>
            ...
            <div class="modal fade" id="deleteTemplate" style="">
                <!-- delete template category -->
                <div class="modal-dialog modal-lg" style="width:30%;">
                    <div class="modal-content">
                        <!---- Modal Header -->
                        <form method="post" id="delete_template_category"
                            action="" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" id="id" value="id">
                            <div class="modal-header" style="padding:0rem 0rem;">
                                <div style="padding:1rem 1rem;">
                                    <h4 class="text-centre"><b>Delete <span id="delete_template"></span></b></h4>
                                </div>
                            </div>
                            <!-- Modal body -->
                            <div class="modal-body">
