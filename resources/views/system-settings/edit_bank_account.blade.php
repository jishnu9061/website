...
<nav style="font-size:15px;">
    ...
    <a href="{{url('bank_details#')}}" style="color: #1D1D50;">Bank Account Details</a> /
    <a href="#" style="color: #1D1D50;">Edit Bank Account Details</a>
</nav>
<br><br>
<div class="container">

    {{-- heading --}}
    <h4 id="hdtpa"><b>Edit Account Details</b></h4>
    <br><br>
                    ...
                    <div class="col-md-4">
                        <div class="mb-1">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="branch" id="username"
                                    value="{{$bank_details->branch}}" required>
                    ...
                    <div class="col-md-4">
                        <div class="mb-1">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="account_name" id="username"
                    ...
                    <div class="col-md-4">
                        <div class="mb-1">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="account_no" id="username"
                                    value="{{$bank_details->account_number}}" required></br>
                    ...
                    <div class="col-md-4">
                        <div class="mb-1">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="branch_code" id="confirm_password"
                                    value="{{$bank_details->branch_code}}" required>
                                <div class="invalid-feedback" style="width: 100%;">
                    ...
                    <div class="col-md-4">
                        <div class="mb-1">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="swift_code" id="confirm_password"
                                    value="{{$bank_details->swift_code}}" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-1">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="mpesa_no" id="confirm_password"
                                    value="{{$bank_details->mpesa_code}}" required>
                                <div class="invalid-feedback" style="width: 100%;">
                                    Telephone Number is required.
                                </div>
                            </div>
