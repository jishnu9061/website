...
<nav style="font-size:15px;">
    ...
    <a href="{{url('leave_days_year')}}" style="color: #1D1D50;">Leave Days Per Year</a> /
    <a href="#" style="color: #1D1D50;">Edit Leave Days</a>
</nav>
<br><br>
<div class="container">

    {{-- heading --}}
    <h4 id="hdtpa"><b>Edit Leave Days Per Year</b></h4>
    <br><br>
                    ...
                    <div class="col-md-4">
                        <div class="mb-1">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" name="leaveday" id="confirm_password" required
                                    value="{{$leave_days->annual_leave_day}}">
