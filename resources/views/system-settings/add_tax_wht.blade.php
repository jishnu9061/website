...
<div>
            <button class="btn btn-primary"
                style="width:100%;background-color:#d6ba8a;color:#1D1D50;border:1px solid gold;font-size:25px"><b><u>Add Tax WHT</u></b></span></button><br>
            ...
            <form method="post" action="add_tax_wht" id="form">  
            @csrf
            <div class="row">
