    ...
    <div class="container">
        ...
        <div>
            <div class="btn btn-primary"
                style="width:100%;background-color:#d6ba8a;color:#1D1D50;border:1px solid gold;font-size:25px"><b><u>Add Bank</u></b></span></div><br>
        ...
        <div  style="margin-right:5%; margin-bottom:5%;" id="mydatatable_filter" class="dataTables_filter">
        <a href="{{url('#')}}"> <i class="fa fa-plus"
                    ...
                    <tbody>
                        <tr id="data">
                            ...
                            <td scope="row" class="text-center">
                                    ...
                                    <a href="{{url('#')}}"><i style="color:black;" class="fa fa-edit"
                                            aria-hidden="true"></i></a>
                                        <a href="{{url('#')}}" onClick="return myFunction();" href="" style="color:black;"><i
