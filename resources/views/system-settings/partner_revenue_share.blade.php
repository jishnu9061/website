...
@section('content')
    ...
    <div class="container">
        ...
        <a href="{{url('add_partner_revenue')}}"><button class="btn btn-primary add-btn"
                style="width: 20%; margin-bottom:5%;">Add New Entry</button></a>
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">

            <h5 style="text-align:center; ">Partner Revenue Share</h5>
