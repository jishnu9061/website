...
<div>
            <button class="btn btn-primary"
                style="width:100%;background-color:#d6ba8a;color:#1D1D50;border:1px solid gold;font-size:25px"><b><u>Add Tax Charts</u></b></span></button><br>
            ...
            <br>
            <br> <br>
       <form method="post" action="add_tax_chart" id="form">  
       @csrf
