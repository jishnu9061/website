           ...
           <table class="table table-striped table-class" id= "table-id">
                      ...
                      <tr class="text-center">
                                ...
                                {{-- <td class="text-center"><label class="switch">
                                    <input type="checkbox" data-id="{{ $excise_tax->id }}"
                                        onclick="changestatus(this)" id="status" class="check"
                                        {{$excise_tax->status == 1 ? 'checked' : '' }}>
                                    ...
                                    <td scope="row"class="text-center">
                                       ...
                                       <div class="dropdown-menu">
                                        {{-- <a class="dropdown-item"
                                            href="{{url('edit_tax_excise',$excise_tax->id)}}">Edit Tax  Excise</a> --}}
                                            <a class="dropdown-item" data-toggle="modal"
                                                data-target="#edit_taxexcise" href="#">Edit Excise Tax</a>
                                        <a class="dropdown-item"
                                            {{-- href="{{url('delete_tax_excise',$excise_tax->id)}}">Delete Tax  Excise</a> --}}
                                            <a href="#"onclick=deletetaxexcise(this) data-id="{{ $excise_tax->id }}"data-toggle="modal"
                                                data-target="#delete_taxexcise">Delete Excise Tax</a>
                                    </div>
                                        </td>
                            </tr>
                            @endforeach
...
<br>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container">
                    ...
                    <form method="post" action="{{ url('add_tax_excise') }}" enctype="multipart/form-data" >
                        @csrf
                        <div class="container">
                            <div class="row">
 ...
 {{-- Start Edit Tax Excise--}}
<div class="modal fade" id="edit_taxexcise" style="">
    <!-- edit  -->
    ...
    <div class="modal fade" id="delete_taxexcise" style=""> <!-- delete -->
        <div class="modal-dialog modal-lg" style="width:30%;">
            <div class="modal-content">
                <!---- Modal Header -->
                <form method="post"  id="delete_taxexcise" action="{{url('delete_tax_excise',$excise_tax->id)}}" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" id="id" value="id">
                    <div class="modal-header" style="padding:0rem 0rem;">
                        <div style="padding:1rem 1rem;"><h4 class="text-centre"><b>Delete <span id="delete_taxexcise"></span></b></h4></div>
                    </div>
                    <!-- Modal body -->
                    <div class="modal-body" >
                        <div class="container">
...
<script>
    function changestatus(param) { // change copany status
        ...
        $.ajax({
            type: "post",
            dataType: "json",
            url: "{{ route('changestatus_taxexcise') }}",
            data: {
                "_token": "{{ csrf_token() }}",
                'status': status,
                'id': user_id
