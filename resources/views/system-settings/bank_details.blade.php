...
<body>
    ...
    <div class="container">
        ...
        <a href="{{url('add_bank_account')}}"><button class="btn btn-primary add-btn"
                style="width: 20%; margin-bottom:5%;">Add New Account</button></a>
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">

            <h5 style="text-align:center; ">Bank Account Details</h5>
                ...
                <table class="table table-bordered" id="new-item">
                    ...
                    <tbody>
                        <tr id="data">
                            ...
                            <td scope="row" class="text-center"></td>
                            <td scope="row" class="text-center"></td>
                            <td scope="row" class="text-center"> <a href="{{url('edit_bank_account')}}">Edit</a> </td>
