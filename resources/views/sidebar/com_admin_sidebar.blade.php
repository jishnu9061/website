    ...
    <div id="demo" class="sidebar-menu">
        <ul class="menu">
            <li class="sidebar-title"
                style="background-color:#1D1D50;color: #dcdce7; text-align:center; font-size:16px;border: 0.1px solid #0606067d;
            border-radius: 2rem;margin:0px 20px; ">
                Company Admin </span>
            </li>
            @if (Auth::user()->role == '2')
                <li id="1" class="sidebar-item  has-sub">{{-- First menu --}}
                    ...
                    @php
                        $admin = ['company_branch', 'change_user_password', 'manage_user_roles', 'view_roles_per_user', 'manage_user_group', 'manage_user_department', 'manage_towns'];
                    @endphp
                    ...
                    @endif
                    @if (request()->path() == 'company_branch')
                        {{-- 1st submenu start --}}
        ...
        <li id="2" class="sidebar-item  has-sub">{{--  Second menu --}}
            ...
            @php
                $admin = ['corporate-list', 'client_list', 'communication-list', 'complaint-list', 'asign-lawyer'];
            @endphp
            @if (in_array(request()->path(), $admin))
                <ul class="submenu" style="display: block;">
                @else
                    <ul class="submenu" style="display: none;">
            @endif
            @if (request()->path() == 'corporate-list')
                {{-- 1st-> 1st  submenu start  --}}
        <li class="submenu-item ">
            <a href="{{ url('corporate-list') }}" class='sidebar-link' style="background-color:#1D1D50 ; color:white;">
                <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Corporate Client
                    List</span>
            @else
        <li class="submenu-item ">
        ...
        @if (request()->path() == 'client_list')
            {{-- 1st->2nd submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('client_list') }}" class='sidebar-link' style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Individual
                        Client List</span>
                @else
            <li class="submenu-item ">
        ...
        @if (request()->path() == 'communication-list')
            {{-- 2nd submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('communication-list') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Client
                        Communication</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('communication-list') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'complaint-list')
            {{-- 3rd submenu start --}}
            <li class="submenu-item " style="background-color:#1D1D50 ; color:white;">
                <a href="{{ url('complaint-list') }}" class='sidebar-link'>
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Complaint
                        Register</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('complaint-list') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'asign-lawyer')
            {{-- 4th submenu start  --}}
            <li class="submenu-item ">
                <a href="{{ url('asign-lawyer') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Assign
                        Lawyer</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('asign-lawyer') }}" class='sidebar-link'>
        ...
        <li id="3" class="sidebar-item  has-sub">{{-- Third menu --}}
            ...
            @php
                $admin = ['file-list', 'file-progress-list', 'file-archive', 'file-list-progress-report', 'bringup', 'file-progress-report', 'file-status-summary', 'client-monthly-file-status', 'staff-monthly-status-report', 'diary-management', 'work-flow', 'template-category', 'document-manager', 'file_instruction', 'office_instructions', 'instructions_report', 'file-report', 'file-opened-report', 'file-closed-report', 'file-pending', 'file-pending-approval', 'instructions-past', 'file_managementindex', 'Safe_management', 'Request_staff_item', 'Process_Request', 'outgoing-letters', 'incomming-letters', 'safe-register-report', 'safe-item-request'];
            @endphp
            @if (in_array(request()->path(), $admin))
                <ul class="submenu" style="display: block;">
                @else
                    <ul class="submenu" style="display: none;">
            @endif
            @if (request()->path() == 'file-list')
                {{-- 1st  submenu start --}}
        <li class="submenu-item ">
            <a href="{{ url('file-list') }}" class='sidebar-link' style="background-color:#1D1D50 ; color:white;">
                <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Manage
                    Files</span>
            @else
        <li class="submenu-item ">
        ...
        @if (request()->path() == 'file-progress-list')
            {{-- 2nd  submenu start --}}
            <li class="submenu-item ">
        ...
        @if (request()->path() == 'file-list-progress-report')
            {{-- 4th  submenu start --}}
            <li class="submenu-item ">
        ...
        @if (request()->path() == 'bringup')
            {{-- 5th  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('bringup') }}" class='sidebar-link' style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Bringup
                        Report</span>
                @else
            <li class="submenu-item ">
        ...
        @if (request()->path() == 'file-progress-report')
            {{-- 6th  submenu start --}}
            <li class="submenu-item ">
        ...
        @if (request()->path() == 'file-status-summary')
            {{-- 7th  submenu start --}}
            <li class="submenu-item ">
        ...
        @if (request()->path() == 'client-monthly-file-status')
            {{-- 8th  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('client-monthly-file-status') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Monthly
                        File Status Report</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('client-monthly-file-status') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'staff-monthly-status-report')
            {{-- 9th  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('staff-monthly-status-report') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Monthly
                        Staff Status Report</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('staff-monthly-status-report') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'diary-management')
            {{-- 10th  submenu start --}}
            <li class="submenu-item ">
        ...
        @if (request()->path() == 'work-flow')
            {{-- 11th  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('work-flow') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Workflow
                        Management</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('work-flow') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'template-category')
            {{-- 12th  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('template-category') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Document
                        Templates</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('template-category') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'document-manager')
            {{-- 13th  submenu start --}}
            <li class="submenu-item ">
        ...
        @if (request()->path() == 'file_instruction')
            {{-- 14th  submenu start --}}
            <li class="submenu-item ">
        ...
        @if (request()->path() == 'office_instructions')
            {{-- 15th  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('office_instructions') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Office
                        Instructions</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('office_instructions') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'instructions_report')
            {{-- 16th  submenu start --}}
            <li class="submenu-item ">
        ...
        @if (request()->path() == 'file-opened-report')
            {{-- 18th  submenu start --}}
            <li class="submenu-item ">
        ...
        @if (request()->path() == 'file-closed-report')
            {{-- 19th  submenu start --}}
            <li class="submenu-item ">
        ...
        @if (request()->path() == 'file-pending-approval')
            {{-- 21st  submenu start --}}
            <li class="submenu-item ">
        ...
        @if (request()->path() == 'instructions-past')
            {{-- 22nd  submenu start --}}
            <li class="submenu-item ">
        ...
        @if (request()->path() == 'file_managementindex')
            {{-- 23rd  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('file_managementindex') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Unallocated
                        Files Report</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('file_managementindex') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'Safe_management')
            {{-- 24th  submenu start --}}
            <li class="submenu-item ">
        ...
        @if (request()->path() == 'Request_staff_item')
            {{-- 25th  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('Request_staff_item') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Request
                        Safe Item</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('Request_staff_item') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'Process_Request')
            {{-- 26th  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('Process_Request') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Process
                        Request</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('Process_Request') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'outgoing-letters')
            {{-- 27th  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('outgoing-letters') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Outgoing
                        Letters</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('outgoing-letters') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'incomming-letters')
            {{-- 28th  submenu start --}}
            <li class="submenu-item ">
        ...
        @if (request()->path() == 'safe-register-report')
            {{-- 30th  submenu start --}}
            <li class="submenu-item ">
        ...
        @if (request()->path() == 'safe-item-request')
            {{-- 31st  submenu start --}}
            <li class="submenu-item ">
        ...
        <li class="sidebar-item  has-sub">{{-- Fourth menu --}}
            ...
            @php
                $admin = ['employee_list/' . Auth::user()->company_id, 'add_staff', 'staffs', 'recruitment', 'performance_department', 'loans', 'payslip', 'attendanceview', 'attendance', 'timesheet', 'task_allocation', 'leave_request_details', 'attendance_sheet', 'bank_names', 'internal_memos'];
            @endphp
            @if (in_array(request()->path(), $admin))
                <ul class="submenu" style="display: block;">
                @else
                    <ul class="submenu" style="display: none;">
            @endif
            @if (request()->path() == 'employee_list/' . Auth::user()->company_id)
                {{-- 0th  submenu start --}}
        <li class="submenu-item ">
            <a href="{{ url('employee_list/' . Auth::user()->company_id) }}" class='sidebar-link'
                style="background-color:#1D1D50 ; color:white;">
                <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Employee
                    List</span>
            @else
        <li class="submenu-item ">
            <a href="{{ url('employee_list/' . Auth::user()->company_id) }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'create_employee/' . Auth::user()->company_id)
            {{-- 0_1th  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('create_employee/' . Auth::user()->company_id) }}"
                    class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
        ...
        @if (request()->path() == 'performance_department')
            {{-- 3rd submenu start --}}
            <li class="submenu-item ">
        ...
        @if (request()->path() == 'payslip')
            {{-- 5th submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('payslip') }}" class='sidebar-link' style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span
        ...
        @if (request()->path() == 'attendanceview')
            {{-- 6th submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('attendanceview') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Attendance
                        (Manual)</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('attendanceview') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'leave_request_details')
            {{-- 10th submenu start --}}
            <li class="submenu-item ">
        ...
        @if (request()->path() == 'attendance_sheet')
            {{-- 11th submenu start --}}
            <li class="submenu-item ">
        ...
        @if (request()->path() == 'internal_memos')
            {{-- 13th submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('internal_memos') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Internal
                        Memos</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('internal_memos') }}" class='sidebar-link'>
        ...
        <li class="sidebar-item  has-sub">{{-- Fifth menu --}}
            ...
            @php
                $admin = ['ledger_acount_categories', 'ledger_acount_subcategories', 'ledger_budget_category', 'ledger_acounts', 'ledger', 'journal', 'budget_forecasting', 'budget_forecat_dept', 'i_p_bank_bal', 'reconcile_bank_entries', 'bank_recon_report', 'expense_report', 'm_c_report', 'vat_report', '', '', 'profitandlossaccount', 'trialbalance', 'balancesheet', '', 'cash_flow_stmt', ''];
            @endphp
            @if (in_array(request()->path(), $admin))
                <ul class="submenu" style="display: block;">
                @else
                    <ul class="submenu" style="display: none;">
            @endif
            @if (request()->path() == 'ledger_acount_categories')
                {{-- 1st  submenu start --}}
        <li class="submenu-item ">
            <a href="{{ url('ledger_acount_categories') }}" class='sidebar-link'
                style="background-color:#1D1D50 ; color:white;">
                <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Account
                    Type</span>
            @else
        <li class="submenu-item ">
            <a href="{{ url('ledger_acount_categories') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'ledger_acount_subcategories')
            {{-- 2nd  submenu start --}}
            <li class="submenu-item ">
        ...
        @if (request()->path() == 'ledger_budget_category')
            {{-- 3rd  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('ledger_budget_category') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Budget
                        Group</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('ledger_budget_category') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'ledger_acounts')
            {{-- 4th  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('ledger_acounts') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Ledger
                        Account</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('ledger_acounts') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'ledger')
            {{-- 5th  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('ledger') }}" class='sidebar-link' style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Ledger
                        Listing</span>
                @else
            <li class="submenu-item ">
        ...
        @if (request()->path() == 'budget_forecasting')
            {{-- 7th  submenu start --}}
            <li class="submenu-item ">
        ...
        @if (request()->path() == 'budget_forecat_dept')
            {{-- 8th  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('budget_forecat_dept') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Budget
                        Forecasting Department</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('budget_forecat_dept') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'reconcile_bank_entries')
            {{-- 10th  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('reconcile_bank_entries') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Reconcile
                        Bank Entries</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('reconcile_bank_entries') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'bank_recon_report')
            {{-- 11th  submenu start --}}
            <li class="submenu-item ">
        ...
        @if (request()->path() == 'expense_report')
            {{-- 12th  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('expense_report') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Expense
                        Report</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('expense_report') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'm_c_report')
            {{-- 13th  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('m_c_report') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Monthly
                        Comparative Report</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('m_c_report') }}" class='sidebar-link'>
        ...
        @if (request()->path() == '')
            ...
            <li class="submenu-item ">
                <a href="{{ url('') }}" class='sidebar-link' style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Withholding
                        TAX(WHT) Report</span>
                @else
            <li class="submenu-item ">
        ...
        @if (request()->path() == 'profitandlossaccount')
            {{-- 17th  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('profitandlossaccount') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Income and
                        Expenditure Statement</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('profitandlossaccount') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'balancesheet')
            {{-- 19th  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('balancesheet') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Balance
                        Sheet</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('balancesheet') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'cash_flow_stmt')
            {{-- 21st  submenu start --}}
            <li class="submenu-item ">
        ...
        @if (request()->path() == '')
            ...
            <li class="submenu-item ">
                <a href="{{ url('') }}" class='sidebar-link' style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Partners
        ...
        <li class="sidebar-item  has-sub">{{-- Sixth menu --}}
            ...
            @php
                $admin = ['stock_list', 'add_categories', 'manage_items', 'request_item', 'item_movement', 're_order'];
            @endphp
            @if (in_array(request()->path(), $admin))
                <ul class="submenu" style="display: block;">
                @else
        ...
        <li class="sidebar-item  has-sub">{{-- Seventh menu --}}
            ...
            @php
                $admin = ['purchase_order/' . Auth::user()->company_id, 'purchase_order_report', 'supplier'];
            @endphp
            @if (in_array(request()->path(), $admin))
                <ul class="submenu" style="display: block;">
                @else
                    <ul class="submenu" style="display: none;">
            @endif
            @if (request()->path() == 'purchase_order/' . Auth::user()->company_id)
                {{-- 1st  submenu start --}}
        <li class="submenu-item ">
        ...
        @if (request()->path() == 'purchase_order_report/' . Auth::user()->company_id)
            {{-- 2nd  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('purchase_order_report/' . Auth::user()->company_id) }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Purchase
                        Orders reports</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('purchase_order_report/' . Auth::user()->company_id) }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'supplier/' . Auth::user()->company_id)
            {{-- 3rd  submenu start --}}
            <li class="submenu-item ">
        ...
        <li class="sidebar-item  has-sub">{{--  Eighth menu --}}
            ...
            @php
                $admin = ['task_allocation','family_law', 'personal_injury', 'general_practice', 'estate_plan', 'real_estate', 'criminal_law', 'civil_litigation', 'business_law', 'guardianship_law', 'probate_law', 'workers_compensation', 'practice_area'];
            @endphp
            @if (in_array(request()->path(), $admin))
                <ul class="submenu" style="display: block;">
                @else
                    <ul class="submenu" style="display: none;">
            @endif
            @if (request()->path() == 'task_allocation')
            <li class="submenu-item ">
        ...
        @endif
            ...
            @if (request()->path() == 'family_law')
                {{-- 1st  submenu start --}}
        <li class="submenu-item ">
            <a href="{{ url('family_law') }}" class='sidebar-link' style="background-color:#1D1D50 ; color:white;">
                <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Family
                    Law</span>
            @else
        <li class="submenu-item ">
        ...
        @if (request()->path() == 'personal_injury')
            {{-- 2nd  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('personal_injury') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Personal
                        Injury</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('personal_injury') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'general_practice')
            {{--  3rd  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('general_practice') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">General
                        Practice</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('general_practice') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'estate_plan')
            {{-- 4th  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('estate_plan') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Estate
                        Planning</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('estate_plan') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'criminal_law')
            {{-- 6th  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('criminal_law') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Criminal
                        Law</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('criminal_law') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'civil_litigation')
            {{-- 7th  submenu start --}}
            <li class="submenu-item ">
        ...
        @if (request()->path() == 'business_law')
            {{-- 8th  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('business_law') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Businesss
                        Law</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('business_law') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'guardianship_law')
            {{-- 9th  submenu start --}}
            <li class="submenu-item ">
        ...
        @if (request()->path() == 'probate_law')
            {{-- 10th  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('probate_law') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Probate
                        Law</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('probate_law') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'workers_compensation')
            {{-- 11th  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('workers_compensation') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Workers
                        Compensation</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('workers_compensation') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'practice_area')
            {{-- 12th  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('practice_area') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Practice
                        Area</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('practice_area') }}" class='sidebar-link'>
        ...
        <li class="sidebar-item  has-sub">{{-- Nineth menu --}}
            ...
            @php
                $admin = ['subject_category/' . Auth::user()->company_id, 'subject', 'file', 'precedence', 'site'];
            @endphp
            @if (in_array(request()->path(), $admin))
                <ul class="submenu" style="display: block;">
                @else
                    <ul class="submenu" style="display: none;">
            @endif
            @if (request()->path() == 'subject_category/' . Auth::user()->company_id)
                {{-- 1st  submenu start --}}
        <li class="submenu-item ">
        ...
        @if (request()->path() == 'subject/' . Auth::user()->company_id)
            {{-- 2nd  submenu start --}}
            <li class="submenu-item ">
        ...
        @if (request()->path() == 'file/' . Auth::user()->company_id)
            {{-- 3rd  submenu start --}}
            <li class="submenu-item ">
        ...
        @if (request()->path() == 'precedence/' . Auth::user()->company_id)
            {{-- 4th  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('precedence/' . Auth::user()->company_id) }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Precedence
                        Register</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('precedence/' . Auth::user()->company_id) }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'site/' . Auth::user()->company_id)
            {{-- 5th  submenu start --}}
            <li class="submenu-item ">
        ...
        <li class="sidebar-item  has-sub">{{-- Tenth menu --}}
            ...
            @php
                $admin = ['tender_details', 'apply_tender', 'tender_applied_details'];
            @endphp
            @if (in_array(request()->path(), $admin))
                <ul class="submenu" style="display: block;">
                @else
                    <ul class="submenu" style="display: none;">
            @endif
            @if (request()->path() == 'tender_details')
                {{-- 1st  submenu start --}}
        <li class="submenu-item ">
            <a href="{{ url('tender_details') }}" class='sidebar-link'
                style="background-color:#1D1D50 ; color:white;">
                <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Tender
                    Details</span>
            @else
        <li class="submenu-item ">
            <a href="{{ url('tender_details') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'tender_applied_details')
            {{-- 3rd  submenu start --}}
            <li class="submenu-item ">
        ...
        <li class="sidebar-item  has-sub">{{-- Eleventh menu --}}
            ...
            @if (in_array(request()->path(), $admin))
                ...
                @else
                    <ul class="submenu" style="display: none;">
            @endif
            @if (request()->path() == 'creditor_list')
                {{-- 1st  submenu start --}}
        <li class="submenu-item ">
            <a href="{{ url('creditor_list') }}" class='sidebar-link'
                style="background-color:#1D1D50 ; color:white;">
                <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Creditor
                    List</span>
            @else
        <li class="submenu-item ">
            <a href="{{ url('creditor_list') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'creditors_aging_report')
            {{-- 2nd submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('creditors_aging_report') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Creditors
                        Aging Report</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('creditors_aging_report') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'supplier_expense_report')
            {{-- 3rd submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('supplier_expense_report') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Supplier
                        Expense Report</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('supplier_expense_report') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'pay_supplier_invoice')
            {{-- 4th submenu start --}}
            <li class="submenu-item ">
        ...
        @if (request()->path() == 'supplier_credit_notes')
            {{-- 5th submenu start --}}
            <li class="submenu-item ">
        ...
        @if (request()->path() == 'supplier_invoice')
            {{-- 6th submenu start --}}
            <li class="submenu-item ">
        ...
        @if (request()->path() == 'supplier_monthly_schedule')
            {{-- 7th submenu start --}}
            <li class="submenu-item ">
        ...
        @if (request()->path() == 'suppliers_list')
            {{-- 8th submenu start --}}
            <li class="submenu-item ">
        ...
        @if (request()->path() == 'cheque')
            {{-- 10th submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('cheque') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Cheque
                        Cancellation</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('cheque') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'contractual_supplier')
            {{-- 14th submenu start --}}
            <li class="submenu-item " style="background-color:#1D1D50 ; color:white;">
        ...
        @if (request()->path() == 'payments_transfer')
            {{-- 15th submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('payments_transfer') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Office
                        Payments Transfers</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('payments_transfer') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'payment_report')
            {{-- 16th submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('payment_report') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Payment
                        Reports</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('payment_report') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'settled_fee')
            {{-- 19th submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('settled_fee') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Settled
                        Paid Legal Fees</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('settled_fee') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'settlement_report')
            {{-- 20th submenu start --}}
            <li class="submenu-item ">
        ...
        @if (request()->path() == 'undeposited_fund')
            {{-- 21st submenu start --}}
            <li class="submenu-item ">
        ...
        <li class="sidebar-item  has-sub">{{-- Twelveth menu --}}
            ...
            @php
                $admin = ['Corporate', 'view-registration', 'lead', 'follow-up', 'Quotation', 'manage_tasks', 'projects', 'expense', 'crm_panel'];
            @endphp
            @if (in_array(request()->path(), $admin))
                <ul class="submenu" style="display: block;">
                @else
        ...
        <li class="submenu-item ">
            <a href="{{ url('Corporate') }}" class='sidebar-link'
                ...
                <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Corporate
                    Customers</span>
            @else
        <li class="submenu-item ">
            <a href="{{ url('Corporate') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'view-registration')
            {{-- 2nd  submenu start --}}
        ...
        <li class="sidebar-item  has-sub">{{-- Thirteenth menu --}}
            ...
            @php
                $admin = ['company_details', 'weekend_holiday', 'other_confgn', 'file_types', 'invoice_items', 'currency_list', 'database_backup', 'Transport_zones', 'billable_activities', 'bank_details', 'leave_days_year', 'hourly_rates', 'partner_revenue_share', 'menu_access_configuration', 'useful_links'];
            @endphp
            @if (in_array(request()->path(), $admin))
                <ul class="submenu" style="display: block;">
                @else
        ...
        @if (request()->path() == 'weekend_holiday')
            {{-- 2nd  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('weekend_holiday') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Weekends
                        and Holidays</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('weekend_holiday') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'invoice_items')
            {{-- 5th  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('invoice_items') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Invoice
                        Items</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('invoice_items') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'currency_list')
            {{-- 6th  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('currency_list') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Currency
                        List</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('currency_list') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'database_backup')
            {{-- 7th  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('database_backup') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Database
                        Backup</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('database_backup') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'Transport_zones')
            {{-- 8th  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('Transport_zones') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Transport
                        Zones</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('Transport_zones') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'billable_activities')
            {{-- 9th  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('billable_activities') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Billable
                        Activities</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('billable_activities') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'leave_days_year')
            {{-- 11th  submenu start --}}
            <li class="submenu-item ">
        ...
        @if (request()->path() == 'hourly_rates')
            {{-- 12th  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('hourly_rates') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Hourly
                        Rates</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('hourly_rates') }}" class='sidebar-link'>
        ...
        @if (request()->path() == 'menu_access_configuration')
            {{-- 13th  submenu start --}}
            <li class="submenu-item ">
        ...
        @if (request()->path() == 'useful_links')
            {{-- 14th  submenu start --}}
            <li class="submenu-item ">
                <a href="{{ url('useful_links') }}" class='sidebar-link'
                    style="background-color:#1D1D50 ; color:white;">
                    <span style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Useful
                        Link</span>
                @else
            <li class="submenu-item ">
                <a href="{{ url('useful_links') }}" class='sidebar-link'>
