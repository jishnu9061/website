        ...
        <ul class="menu">
            ...
            border-radius: 2rem;margin:0px 20px; ">Company Admin </span>
                ...
                <li id="1"class="sidebar-item  has-sub">{{-- First menu --}}
                    <a href="#" class='sidebar-link'>
                        <i id="icon" class="fa-regular fa-user"  style="font-weight: 300;"></i>
                            <span style="margin-left: 1rem;">User Management</span>
                    </a>
                    @php
                    ...
                    @endif
                        @if(request()->path()== "manage_user_account"){{--1st submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('manage_user_account')}}" class='sidebar-link' style="background-color:#1D1D50 ; color:white;">
                        ...
                        @if(request()->path()== "change_user_password"){{--2nd submenu start--}}
                            <li class="submenu-item " >
                                <a href="{{url('change_user_password')}}" class='sidebar-link' style="background-color:#1D1D50 ; color:white;">
                        ...
                        @if(request()->path()== "manage_user_roles"){{--3rd submenu start--}}
                            <li class="submenu-item " >
                                <a href="{{url('manage_user_roles')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                        ...
                        @if(request()->path()== "manage_user_group"){{-- 5th submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('manage_user_group')}}" class='sidebar-link' style="background-color:#1D1D50 ; color:white;">
                        ...
                        @if(request()->path()== "manage_user_department"){{--6th submenu start  --}}
                            <li class="submenu-item " >
                                <a href="{{url('manage_user_department')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                        ...
                        @if(request()->path()== "manage_towns"){{-- 7th submenu start --}}
                            <li class="submenu-item ">
                                <a href="{{url('manage_towns')}}" class='sidebar-link' style="background-color:#1D1D50 ; color:white;">
                ...
                <li id="2"class="sidebar-item  has-sub">{{--  Second menu--}} 
                    ...
                    @endif
                        ...
                        @if(request()->path()== "communication-list"){{-- 2nd submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('communication-list')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Client Communication</span>
                            @else
                                <li class="submenu-item ">
                        ...
                        @if(request()->path()== "complaint-list"){{-- 3rd submenu start --}}
                            <li class="submenu-item " style="background-color:#1D1D50 ; color:white;">
                                <a href="{{url('complaint-list')}}" class='sidebar-link'>
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Complaint Register</span>
                            @else
                                <li class="submenu-item ">
                                    <a href="{{url('complaint-list')}}" class='sidebar-link'>
                        ...
                        @if(request()->path()== "asign-lawyer"){{--4th submenu start  --}}
                            <li class="submenu-item ">
                                <a href="{{url('asign-lawyer')}}" class='sidebar-link' style="background-color:#1D1D50 ; color:white;">
                ...
                <li id="3"class="sidebar-item  has-sub">{{-- Third menu --}}
                    ...
                    @endif
                        @if(request()->path()== "file-list"){{-- 1st  submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('file-list')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Manage Files</span>
                            @else
                                <li class="submenu-item ">
                        ...
                        @if(request()->path()== "file-progress-list"){{-- 2nd  submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('file-progress-list')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">File Progress/Bringups</span>
                            @else
                                <li class="submenu-item ">
                        ...
                        @if(request()->path()== "file-archive"){{-- 3rd  submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('file-archive')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">File Archive</span>
                            @else
                                <li class="submenu-item ">
                        ...
                        @if(request()->path()== "file-list-progress-report"){{-- 4th  submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('file-list-progress-report')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">File List Progress Report</span>
                            @else
                                <li class="submenu-item ">
                        ...
                        @if(request()->path()== "bringup"){{-- 5th  submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('bringup')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Bringup Report</span>
                            @else
                                <li class="submenu-item ">
                        ...
                        @if(request()->path()== "file-progress-report"){{-- 6th  submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('file-progress-report')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">File Progress Report</span>
                            @else
                                <li class="submenu-item ">
                        ...
                        @if(request()->path()== "client-monthly-file-status"){{-- 8th  submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('client-monthly-file-status')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Monthly File Status Report</span>
                            @else
                                <li class="submenu-item ">
                        ...
                        @if(request()->path()== "staff-monthly-status-report"){{-- 9th  submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('staff-monthly-status-report')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Monthly Staff Status Report</span>
                            @else
                                <li class="submenu-item ">
                        ...
                        @if(request()->path()== "diary-management"){{-- 10th  submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('diary-management')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Diary Management</span>
                            @else
                                <li class="submenu-item ">
                        ...
                        @if(request()->path()== "work-flow"){{-- 11th  submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('work-flow')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Workflow Management</span>
                            @else
                                <li class="submenu-item ">
                        ...
                        @if(request()->path()== "template-category"){{-- 12th  submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('template-category')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Document Templates</span>
                            @else
                                <li class="submenu-item ">
                        ...
                        @if(request()->path()== "document-manager"){{-- 13th  submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('document-manager')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Document Manager(DMS)</span>
                            @else
                                <li class="submenu-item ">
                        ...
                        @if(request()->path()== "office_instructions"){{-- 15th  submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('office_instructions')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Office Instructions</span>
                            @else
                                <li class="submenu-item ">
                        ...
                        @if(request()->path()== "instructions_report"){{-- 16th  submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('instructions_report')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Instructions Report</span>
                            @else
                                <li class="submenu-item ">
                        ...
                        @if(request()->path()== "file-report"){{-- 17th  submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('file-report')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">File Reports</span>
                            @else
                                <li class="submenu-item ">
                        ...
                        @if(request()->path()== "file-pending") {{-- 20th  submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('file-pending')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Files Pending Closure</span>
                            @else
                                <li class="submenu-item ">
                        ...
                        @if(request()->path()== "file_managementindex"){{-- 23rd  submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('file_managementindex')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Unallocated Files Report</span>
                            @else
                                <li class="submenu-item ">
                        ...
                        @if(request()->path()== "Safe_management"){{-- 24th  submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('Safe_management')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Safe Manangement</span>
                            @else
                                <li class="submenu-item ">
                        ...
                        @if(request()->path()== "Request_staff_item"){{-- 25th  submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('Request_staff_item')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Request Safe Item</span>
                            @else
                                <li class="submenu-item ">
                        ...
                        @if(request()->path()== "Process_Request"){{-- 26th  submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('Process_Request')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Process Request</span>
                            @else
                                <li class="submenu-item ">
                        ...
                        @if(request()->path()== "outgoing-letters"){{-- 27th  submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('outgoing-letters')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Outgoing Letters</span>
                            @else
                                <li class="submenu-item ">
                        ...
                        @if(request()->path()== "safe-register-report"){{-- 30th  submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('safe-register-report')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Safe Register Report</span>
                            @else
                                <li class="submenu-item ">
                        ...
                        @if(request()->path()== "safe-item-request"){{-- 31st  submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('safe-item-request')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Safe Item Request Report</span>
                            @else
                                <li class="submenu-item ">
                ...
                <li class="sidebar-item  has-sub">{{-- Fourth menu --}}
                    ...
                    @endif
                        @if(request()->path()== "staffs"){{-- 1st  submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('staffs')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Manage Staffs</span>
                            @else
                                <li class="submenu-item ">
                        ...
                        @if(request()->path()== "recruitment"){{-- 2nd submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('recruitment')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                        ...
                        @if(request()->path()== "performance_department"){{-- 3rd submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('performance_department')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                        ...
                        @if(request()->path()== "payslip"){{-- 5th submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('payslip')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Payslip(Bulk)</span>
                            @else
                            <li class="submenu-item ">
                        ...
                        @if(request()->path()== "attendanceview"){{-- 6th submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('attendanceview')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                        ...
                        @if(request()->path()== "attendance"){{-- 7th submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('attendance')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Attendance (CSV Uploaded)</span>
                            @else
                            <li class="submenu-item ">
                        ...
                        @if(request()->path()== "timesheet"){{-- 8th submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('timesheet')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                        ...
                        @if(request()->path()== "task_allocation")// 9th submenu start
                            <li class="submenu-item " >
                                <a href="{{url('task_allocation')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                        ...
                        @if(request()->path()== "leave_request_details"){{-- 10th submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('leave_request_details')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                        ...
                        @if(request()->path()== "attendance_sheet"){{-- 11th submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('attendance_sheet')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Attendance Sheet</span>
                            @else
                            <li class="submenu-item ">
                        ...
                        @if(request()->path()== "bank_names"){{-- 12th submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('bank_names')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Add Bank</span>
                            @else
                            <li class="submenu-item ">
                        ...
                        @if(request()->path()== "internal_memos"){{-- 13th submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('internal_memos')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Internal Memos</span>
                            @else
                            <li class="submenu-item ">
                ...
                <li class="sidebar-item  has-sub">{{-- Fifth menu --}}
                    ...
                    @php
                        $admin = array("ledger_acount_categories", "ledger_acount_subcategories", "ledger_budget_category", "ledger_acounts", "ledger", "journal", "budget_forecasting", "budget_forecat_dept", "i_p_bank_bal", "reconcile_bank_entries", "bank_recon_report", "expense_report", "m_c_report", "vat_report", "", "", "profitandlossaccount", "trialbalance", "balancesheet", "", "cash_flow_stmt", "");
                    @endphp
                    @if (in_array(request()->path(), $admin))
                        <ul class="submenu" style="display: block;">
                        @else
                    ...
                    @endif
                        @if(request()->path()== "ledger_acount_categories"){{-- 1st  submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('ledger_acount_categories')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Account Type</span>
                            @else
                            <li class="submenu-item ">
                        ...
                        @if(request()->path()== "ledger_acount_subcategories"){{-- 2nd  submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('ledger_acount_subcategories')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Account Category</span>
                            @else
                            <li class="submenu-item ">
                        ...
                        @if(request()->path()== "ledger_budget_category"){{-- 3rd  submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('ledger_budget_category')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Budget Group</span>
                            @else
                            <li class="submenu-item ">
                        ...
                        @if(request()->path()== "ledger_acounts"){{-- 4th  submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('ledger_acounts')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Ledger Account</span>
                            @else
                            <li class="submenu-item ">
                        ...
                        @if(request()->path()== "ledger"){{-- 5th  submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('ledger')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Ledger Listing</span>
                            @else
                            <li class="submenu-item ">
                        ...
                        @if(request()->path()== "journal"){{-- 6th  submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('journal')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Journal</span>
                            @else
                            <li class="submenu-item ">
                ...
                <li class="sidebar-item  has-sub">{{-- Sixth menu --}} 
                    ...
                    @endif
                        ...
                        @if(request()->path()== "manage_items"){{-- 3rd  submenu start --}}
                            <li class="submenu-item " >
                                <a href="{{url('manage_items')}}" class='sidebar-link'style="background-color:#1D1D50 ; color:white;">
                                    <span  style="margin-left:0px;font-align:center;">●</span><span style="margin-left:5px">Manage Items</span>
                            @else
                            <li class="submenu-item ">
                ...
                <li class="sidebar-item  has-sub">{{--  Eighth menu --}}
                    ...
                    @php
                        $admin = array("family_law", "personal_injury", "general_practice", "estate_plan", "real_estate", "criminal_law", "civil_litigation", "business_law", "guardianship_law", "probate_law", "workers_compensation", "practice_area");
                    @endphp
                    @if (in_array(request()->path(), $admin))
                        <ul class="submenu" style="display: block;">
                        @else
