...
<div id="demo" class="sidebar-menu">
    <ul class="menu">
        ...
        <li id="1" class="sidebar-item  has-sub">{{-- First menu --}}
            ...
            @php
            $admin = array("manage_user_account", "change_user_password", "manage_user_roles", "view_roles_per_user",
                ...
                <ul class="submenu" style="display: none;">
                    ...
                    <li class="submenu-item ">
                        <a href="{{url('manage_user_account')}}" class='sidebar-link'
                            ...
                            <span style="margin-left:0px;font-align:center;">●</span><span
                                style="margin-left:5px">Manage Accounts</span>
                            @else
                    <li class="submenu-item ">
                        <a href="{{url('manage_user_account')}}" class='sidebar-link'>
                    ...
                    <li class="submenu-item ">
                        <a href="{{url('change_user_password')}}" class='sidebar-link'
                            style="background-color:#1D1D50 ; color:white;">
                            <span style="margin-left:0px;font-align:center;">●</span><span
                                style="margin-left:5px">Change Password</span>
                            @else
                    <li class="submenu-item ">
                        <a href="{{url('change_user_password')}}" class='sidebar-link'>
                    ...
                    <li class="submenu-item ">
                        <a href="{{url('manage_user_roles')}}" class='sidebar-link'
                            style="background-color:#1D1D50 ; color:white;">
                            <span style="margin-left:0px;font-align:center;">●</span><span
                                style="margin-left:5px">Manage Roles</span>
                            @else
                    <li class="submenu-item ">
                        <a href="{{url('manage_user_roles')}}" class='sidebar-link'>
                    ...
                    <li class="submenu-item ">
                        <a href="{{url('manage_user_group')}}" class='sidebar-link'
                            style="background-color:#1D1D50 ; color:white;">
                            <span style="margin-left:0px;font-align:center;">●</span><span
                                style="margin-left:5px">Manage Groups</span>
                            @else
                    <li class="submenu-item ">
                        <a href="{{url('manage_user_group')}}" class='sidebar-link'>
                    ...
                    <li class="submenu-item ">
                        <a href="{{url('manage_user_department')}}" class='sidebar-link'
                            style="background-color:#1D1D50 ; color:white;">
                            <span style="margin-left:0px;font-align:center;">●</span><span
                                style="margin-left:5px">Manage Departments</span>
                            @else
                    <li class="submenu-item ">
                        <a href="{{url('manage_user_department')}}" class='sidebar-link'>
                    ...
                    <li class="submenu-item ">
                        <a href="{{url('manage_towns')}}" class='sidebar-link'
                            style="background-color:#1D1D50 ; color:white;">
                            <span style="margin-left:0px;font-align:center;">●</span><span
                                style="margin-left:5px">Manage Towns</span>
                            @else
                    <li class="submenu-item ">
                        <a href="{{url('manage_towns')}}" class='sidebar-link'>
