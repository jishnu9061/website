...
@section('content')
  ...
  <tbody>
    <tr>
      ...
      <td><input class="form-control" type="text" placeholder="23-11-2022"  aria-label="Disabled input example" disabled></td>
 
    </tr>
    <tr>
      <th scope="row">Order Number</th>
      <td><input class="form-control" type="text" placeholder="62C67947652DC" aria-label="Disabled input example" disabled></td>
    
    </tr>
    <tr>
      <th scope="row">Supplier Name</th>
      <td><input class="form-control" type="text" placeholder="ABC Ltd" aria-label="Disabled input example" disabled></td>
      
    </tr>
    <tr>
      <th scope="row">Payment Type</th>
      <td><input class="form-control" type="text" placeholder="By Cash" aria-label="Disabled input example" disabled></td>
