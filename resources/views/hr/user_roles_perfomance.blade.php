...
<input type="text" id="search_input_all" onkeyup="FilterkeyWord_all_table()" placeholder="Search.." class="form-control">
    ...
    <table class="table table-striped table-class" id= "table-id">
      ...
      <thead>
             ...
             <tbody>
            @foreach($department_roles  as $roles)
                    <tr>
                        <td class="text-center">{{$roles->designation}}</td>
                        <td  scope="row"class="text-center"style="color:rgb(13, 1, 56);">
                                 <a href="{{url('edit_department_perfomance',$roles->id)}}"><i  style="  color:rgb(13, 1, 56);" class="fa fa-edit" aria-hidden="true"></i>
                                 <span class="m-2"></span>
                                 <a href="{{url('destroy_user_department',$roles->id)}}"> <i style="color:rgb(13, 1, 56);"class="fas fa-trash-alt"></i></td>
