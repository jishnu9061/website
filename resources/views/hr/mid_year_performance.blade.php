...
<div class="container">
    ...
    <div class="container">
        ...
        <div class="container">
            ...
            <p>Do you agree with the assessment by the Reporting Officer with respect to the work output ? In case you
                do not agree with any of the numerical assessments of attributes. Please record your assessment in the
                column Provided.</p>
        ...
        <div class="container">
            <div class="mb-3">
                <label for="in case of different opinion, please give the details," class="form-label">In case of
        ...
        <div class="container">
            <div class="mb-3">
                <label for="Overall Grade on a Scale of 1-5 ( in numbers )" class="form-label">Overall Grade on a Scale
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container">
                            <form method="post" action="{{url('add_letter_category')}}" enctype="multipart/form-data">
                                ...
                                <input class="form-control form-control-lg" type="text" placeholder="Enter the KPI"
