...
<div class="tab">
  ...
  <button class="tablinks" onclick="openCity(event, 'deductions')">Deductions</button>
  <a href="{{url('staffsalary'.$users->uniqueid)}}"><button class="tablinks">Salary</button></a>
  <button class="tablinks" onclick="openCity(event, 'loans')">Loans</button>
  <button class="tablinks" onclick="openCity(event,'dutyschedule')">Duty Schedule</button>
...
<div class="" style="background-color: #eaeeff;padding: 50px;">
...
<input type="hidden" value="{{$users->uniqueid}}" id="uniqid">
  ...
  <div class="col-md-3 col-lg-3">
	<input type="text" class="form-control" id="reosonztab" name="reosonztab" placeholder="Reason">
...
$('#percent').prop('readonly', true);
    ...
    var reosonz = $(this).closest('#data').find('#reosonztab').val();
    var loanamountzx = parseFloat(loanamount) / parseFloat(months);
    var loanamountzxrr=Math.round(loanamountzx);

    $('#tot').append((loanamount) + "<br />");
    $('#amdpd').append(('0') + "<br />");
    $('#balpd').append((loanamount) + "<br />");
    $('#mnthlidedct').append((loanamountzxrr) + "<br />");
    $('#reosonz').append((reosonz) + "<br />");
