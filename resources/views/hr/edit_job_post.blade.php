    ...
    <div class="row">
        ...
        <div class="row">
          <div class="col">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control" name="start_date" aria-describedby="startingdate"value="{{$job_details->start_date}}">
            </div>
         </div>
        ...
        <!-- column-2 -->
          ...
          <div class="mb-3">
            ...
            <input type="money" class="form-control" name="salary_range" aria-describedby="salaryrange"value="{{$job_details->salary_range}}">
        </div>
        <div class="mb-3">
            <label for="ending date" class="form-label">Ending Date to Apply</label>
            <input type="date" class="form-control" name="end_date" aria-describedby="endingdate"value="{{$job_details->end_date}}">
          </div> 
        </div>
     ...
     <!-- Job Description -->
        <div class="mb-3">
            ...
            <textarea class="form-control" name="job_description" rows="3">{{$job_details->job_description}}</textarea>
          </div>

    <!-- Responsibilities -->
    <div class="mb-3">
        <label for="job responsibilities" class="form-label">Job Responsibilities</label>
        <textarea class="form-control" name="job_responsibilities" rows="3">{{$job_details->job_responsibilities}}</textarea>
      </div>
</div>
