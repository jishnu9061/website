    ...
    <section>
        ...
        <div class="row sm">
            ...
            <div class="col-sm-4 "> <a href="{{ url('recruitment') }}"><img class="logo_size"
                        ...
                        style="width:70%;" class="btn btn-primary btn_align_btn">Recruitment</button></a></div>
            ...
            <div class="col-sm-4"> <a href="{{ url('loans') }}"><img class="logo_size"
                        ...
                        style="width:70%;" class="btn btn-primary btn_align_btn">Loans</button></a></div>
            <div class="col-sm-4"> <a href="{{ url('payslip') }}"><img class="logo_size"
                        src="assets\image\Monthly file status report.png" alt=""><button type="button"
                        style="width:70%;" class="btn btn-primary btn_align_btn">Payslip (Bulk)</button></a></div>
            <div class="col-sm-4"> <a href="{{ url('attendanceview') }}"><img class="logo_size"1
                        src="assets\image\Monthly Staff status report.png" alt=""><button type="button"
                        style="width:70%;" class="btn btn-primary btn_align_btn">Attendance(Manual)</button></a></div>
            <div class="col-sm-4"> <a href="{{ url('attendance') }}"><img class="logo_size"
                        src="assets\image\Monthly Staff status report.png" alt=""><button type="button"
                        style="width:70%;" class="btn btn-primary btn_align_btn">Attendance(CSV Uploaded)</button></a></div>
