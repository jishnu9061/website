        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="mb-1">
                    ...
                    <div class="input-group">
                        <div class="input-group-prepend"></div>
                        <input type="email" class="form-control" name="email" id="address" value="{{$users->email}}" required>
                        <div class="invalid-feedback" style="width: 100%;">
                            Required Field.
                        </div>
                    </div>
            ...
            <div class="col-md-3">
                <div class="mb-1">
                    ...
                    <div class="input-group">
                        <div class="input-group-prepend"></div>
                        <input type="text" class="form-control" name="phoneno" id="phone_no" value="{{$users->phone}}">
                        <div class="invalid-feedback" style="width: 100%;">
                            Required Field.
                        </div>
                    </div>
            ...
            <div class="col-md-3">
                <div class="mb-1">
                    ...
                    <div class="input-group">
                        <div class="input-group-prepend"></div>
                        <input type="number" class="form-control" value="{{$users->age}}" name="age" id="age" min="0"
                            max="99">
                        <div class="invalid-feedback" style="width: 100%;">
                            Age is required.
                        </div>
                ...
                <div class="mb-1">
                    ...
                    <div class="input-group">
                        ...
                        <input type="date" class="form-control" name="doj"
                            id="" placeholder="" value="{{ date('d-m-Y',strtotime($users->date_of_joining))}}">
                        <div class="invalid-feedback" style="width: 100%;">
                            Passeord is required.
                        </div>
                    </div>
