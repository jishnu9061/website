    ...
    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="consult-tab"><br>
        ...
        <div class="row" >
            <div class="col-md-6 col-lg-6">
                <label><b>Name :</b>{{$patname}}</label><br><br>
                <label><b>Phone :</b>{{$patphn}}</label><br><br>
                <label><b>Address :</b>{{$pataddrs}}</label><br><br>
                <label><b>Age :</b>{{$patage}}</label><br><br>
                <label><b>Email :</b>{{$patemail}}</label><br><br>
            </div>
            <div class="col-md-6 col-lg-6">
            </div>
        </div>
...
<div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
  ...
  <div class="modal fade text-left" id="default" tabindex="-1" role="dialog"
          ...
          <h5 class="modal-title bb" id="myModalLabel1">Patient Name : {{$patname}}</h5>
