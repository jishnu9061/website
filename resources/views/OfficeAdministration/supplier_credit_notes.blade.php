    ...
    <div class="row" style="height:50px;">
        <div class="col-sm-4" style="padding-top:5px;">
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal" style="margin-left:10px;    --clr: #1D1D50;
                --outline: .001px solid var(--clr);color: white;background-color: #1D1D50;border-radius: 5px;">New Credit
            Notes</button>
        </div>
                                    ...
                                    <td scope="row" class="text-center">
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="{{url('view_supplier_credit')}}">View Supplier Credit</a>
                                                <a class="dropdown-item" href="{{url('edit_supplier_credit')}}">Edit Supplier Credit</a>
