    ...
    <div class="container">
        ...
        <div>
            <div class="btn btn-primary"
                ...
                <b><u>Clients Outgoing Letters</u></b></span></div><br>
        ...
        <!-- <a href="{{url('add-outgoing-letters')}}"><button class="btn btn-primary add-btn"
                ...
                {{-- <a href="{{('')}}"><button class="btn btn-primary">Add Outgoing Letter</button></a> --}}
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Add Outgoing Letter</button>
