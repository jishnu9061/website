...
<nav style="font-size:12px;">
      ...
      <a href="#" style="color: #1D1D50;">File Management-Safe Management</a>
</nav>
<br><br>
                            ...
                            <tr id="data">
                                ...
                                <td scope="row" class="text-center">
                                    <a href=""> <i style="color:rgb(13, 1, 56);" class="fa fa-eye"></i>
                                        ...
                                        <a href="{{url('edit_Safe_management',$management->id)}}"><i
                                                style="  color:rgb(13, 1, 56);" class="fa fa-edit"></i>


                                            <a href="{{url('delete_Safe_management',$management->id)}}"> <i
