    ...
    <div class="py-5 text-center">
        ...
        <div>
            ...
            <div class="btn btn-primary"
                style="width:100%;background-color:#d6ba8a;color:#1D1D50;border:1px solid gold;font-size:25px"><b><u>Generate Documents</u></b></span></div><br>
                    ...
                    <div class="col-md-6">
                        <div class="mb-1">
                            ...
                            <div class="input-group">
                                ...
                                <textarea class="form-control" id="form7Example7" name="doc_nature"  rows="3"></textarea>
                            </div>
                        </div>
                    </div>
