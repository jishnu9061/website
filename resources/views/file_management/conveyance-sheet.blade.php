...
<div class="container">
    <div class="py-5 text-center">
        ...
        <div>
            <!-- <h2 style="text-align:center;">Conveyance Sheet</h2>
            <hr class="mb-4">. -->
            <div>
            <button class="btn btn-primary"
                style="width:100%;background-color:#d6ba8a;color:#1D1D50;border:1px solid gold;font-size:25px"><b><u>Conveyance Sheet</u></b></span></button><br>
