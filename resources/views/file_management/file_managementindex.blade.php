    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="row sm">
                ...
                <div class="col-sm-4"> <a href="{{ url('work-flow') }}"><img class="logo_size" src="assets\image\11.png"
                            alt=""><button type="button" style="width:70%;"
            ...
            <div>
                ...
                <div class="row sm">
                    ...
                    <div class="col-sm-4"> <a href=""><img class="logo_size" src="assets\image\14.png" alt=""><button
