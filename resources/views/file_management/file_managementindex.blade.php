...
@section('content')
    ...
    <div class="container">
        ...
        <body>
          ...
          style="width:100%;background-color:#d6ba8a;color:white;border:1px solid gold;font-width:150%"><span class="font-size-lg">File Management Details</span></button><br><br><br>
            <br>
            ...
            <div class="container-fluid">
                ...
                <div class="row sm">
                    <div class="col-sm-4 "> <a href="{{ url('file-list') }}"><img class="logo_size" src="assets\image\2.png"
                                alt=""><button type="button" style="width:70%;"
                                class="btn btn-primary btn_align_btn">Manage Files</button></a></div>
                    ...
                    <div class="col-sm-4 "> <a href="{{ url('file-archive') }}"><img class="logo_size"
                                src="assets\image\3.png" alt=""><button type="button" style="width:70%;"
                ...
                <div class="row sm">
                    <div class="col-sm-4 "> <a href="{{ url('file-list-progress-report') }}"><img class="logo_size"
                                src="assets\image\4.png" alt=""><button type="button" style="width:70%;"
                                class="btn btn-primary btn_align_btn"> File List Progress Report</button></a></div>
                    <div class="col-sm-4 "> <a href="{{ url('bringup') }}"><img class="logo_size" src="assets\image\5.png"
                                alt=""><button type="button" style="width:70%;"
                    ...
                    <div class="col-sm-4 "> <a href="{{ url('file-progress-report') }}"><img class="logo_size"
                                src="assets\image\6.png" alt=""><button type="button" style="width:70%;"
                    ...
                    <div class="col-sm-4"> <a href="{{ url('file-status-summary') }}"><img class="logo_size"
                                src="assets\image\7.png" alt=""><button type="button" style="width:70%;"
                    ...
                    <div class="col-sm-4"> <a href="{{ url('client-monthly-file-status') }}"><img class="logo_size"
                                src="assets\image\8.png" alt=""><button type="button" style="width:70%;"
                    ...
                    <div class="col-sm-4"> <a href="{{ url('staff-monthly-status-report') }}"><img class="logo_size"
                                src="assets\image\9.png" alt=""><button type="button" style="width:70%;"
                ...
                <div class="row sm">
                    <div class="col-sm-4"> <a href="{{ url('diary-management') }}"><img class="logo_size"
                                src="assets\image\10.png" alt=""><button type="button" style="width:70%;"
                                class="btn btn-primary btn_align_btn">Diary Management</button></a></div>
                    <div class="col-sm-4"> <a href="{{ url('work-flow') }}"><img class="logo_size"
                                src="assets\image\11.png" alt=""><button type="button" style="width:70%;"
                    ...
                    <div class="col-sm-4"> <a href="{{ url('template-category') }}"><img class="logo_size"
                                src="assets\image\13.png" alt=""><button type="button" style="width:70%;"
                    ...
                    <div class="col-sm-4"> <a href="{{ url('document-manager') }}"><img class="logo_size"
                                src="assets\image\14.png" alt=""><button type="button" style="width:70%;"
                ...
                <div>
                    ...
                    <div class="row sm">
                        ...
                        <div class="col-sm-4"> <a href="{{ url('office_instructions') }}"><img class="logo_size"
                                    src="assets\image\5.png" alt=""><button type="button" style="width:70%;"
                    ...
                    <br>
                    <button class="btn btn-primary float-left"
                    style="width:30%;background-color:#1D1D50;color:white;border:1px solid gold;">File Reports</button><br><br><br>
                    <div class="row sm">
                        ...
                        <div class="col-sm-4"> <a href=""><img class="logo_size" src="assets\image\14.png"
                                    alt=""><button type="button" style="width:70%;"
                                    class="btn btn-primary btn_align_btn">Unallocated Files Report</button></a></div>

                    </div>
                    <br>
                    <button class="btn btn-primary float-left"
                    style="width:30%;background-color:#1D1D50;color:white;border:1px solid gold;">Add Ons</button><br><br><br>
                    <div class="row sm">
