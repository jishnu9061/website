...
<div class="container">
    ...
    <div>
        ...
        style="width:100%;background-color:#d6ba8a;color:#1D1D50;border:1px solid gold;font-size:25px;"><b><u>File Instructions</u></b></div><br>
            ...
            <table class="table table-bordered" id="new-item">
                    ...
                    <tbody>
                        <tr id="data">
                            ...
                            <td scope="row" class="text-center" id="medicine_name_1"></td>
                            <td scope="row" class="text-center" id="medicine_name_1"></td>
                            <td scope="row" class="text-center"><a href="edit_file_instruction"><i style="color:black;" class="fa fa-edit"
                                        aria-hidden="true"></i>
