...
<body>
    ...
    <div class="container">
        <!-- <h3 class="text-center" style="color: #070344;"><b>Files Pending Approval</b></h3> -->
        <div>
            <button class="btn btn-primary"
                style="width:100%;background-color:#d6ba8a;color:#1D1D50;border:1px solid gold;font-size:25px"><b><u>Files Pending Approval</u></b></span></button><br>
