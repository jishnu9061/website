...
<nav style="font-size:17px;">
    ...
    <a href="{{url('work-flow')}}" style="color: #1D1D50;">Workflow Management</a> /
    <a href="#" style="color: #1D1D50;">Edit Workflow</a>
</nav>
<br><br>
<div class="container">
    <div>
