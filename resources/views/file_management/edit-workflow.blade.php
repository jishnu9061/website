            ...
            <div class="col-md-12 order-md-1">
                ...
                <form method="post" action="{{url('update-workflow')}}" id="form">
                        ...
                        <div class="col-md-4">
                            <div class="mb-1">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="flow_name" id="confirm_password"
                                        required value="{{$edit_flow->Workflow_Name}}">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-1">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="date" class="form-control" name="start_date" id="confirm_password"
                                        required value="{{$edit_flow->Start_Date}}">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-1">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="duration" id="confirm_password"
                                        required value="{{$edit_flow->Duration}}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="mb-1">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea class="form-control" id="edit_medicine_details1" name="flow_comments"
                                        value="" rows="3" placeholder="">{{$edit_flow->Workflow_Comments}}</textarea>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm">
                            <br>
                            <button type="submit" class="btn btn-primary float:right;" Style="width:25%;">
                                Update</button>
