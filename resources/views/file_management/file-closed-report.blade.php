    ...
    <div class="container">
        ...
        <div>
            <button class="btn btn-primary"
                style="width:100%;background-color:#d6ba8a;color:#1D1D50;border:1px solid gold;font-size:25px"><b><u>Files Closed Report</u></b></span></button><br>
                ...
                <table class="table table-bordered" id="new-item">
                    <thead >
                        <tr>
                            ...
                            <th class="text-center">File</br> Closed</br> Number</th>
                            ...
                            <th class="text-center">Retainment </br>Period</th>
                            <th class="text-center">Destruction</br> Date</th>
