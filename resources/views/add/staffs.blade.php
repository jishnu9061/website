                        ...
                        <div class="col-md-4 col-lg-2">
                            ...
                            <div class="card-body">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="patienthere" value="male"
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="patienthere" value="female"
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="patienthere" value="others"
                                        id="flexRadioDefault1" checked>
                                    <label class="form-check-label" for="flexRadioDefault1">
                                        Others
                                    </label>
