                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="mb-1">
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend"></div>
                                <input type="number" class="form-control" name="phoneno" id="username"
                                    placeholder="Phone no" required min="0" max="9999999999">
                                <div class="invalid-feedback" style="width: 100%;">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <select class="custom-select my-1 mr-sm-2 btn btn-secondary dropdown-toggle me-2" name="rolename" id="inlineFormCustomSelectPref">
                                                            ...
                                                            @foreach ($roles as $role)
                                                                <option  class="dropdown-item" value="{{$role->rolename}}">{{$role->rolename}}
                    </option>
                    @endforeach
                    </select>
                </div>
                                                            ...
                                                            <div class="form-group col-md-5">
                                                                <select class="custom-select my-1 mr-sm-2 btn btn-secondary dropdown-toggle me-2" name="depname" id="inlineFormCustomSelectPref">
                                                                    ...
                                                                    @foreach ($departments as $department)
                                                                        <option  class="dropdown-item" value="{{$department->id}}">{{$department->depname}}
        </option>
        @endforeach
        </select>
    </div>
...
<div class="col-md-4 col-lg-2">
    ...
    <div class="card-body">
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="patienthere" value="female" id="flexRadioDefault1"
                checked>
            <label class="form-check-label" for="flexRadioDefault1">
                Female
            </label>
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="patienthere" value="others" id="flexRadioDefault1"
                checked>
            <label class="form-check-label" for="flexRadioDefault1">
                Others
            </label>
...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="mb-1">
            ...
            <div class="input-group">
                <div class="input-group-prepend"></div>
                <input type="number" class="form-control" name="yearsexp" id="username" placeholder="Experience" min="0"
                    max="70">
                <div class="invalid-feedback" style="width: 100%;">
...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="mb-1">
            ...
            <div id="messagelev" style="height:20px; float:right;padding-bottom:10px;height:30px;">
            </div>
            <div class="input-group">
                <div class="input-group-prepend"></div>
                <table class="table">
                    <tr>
                        ...
                        <td>{{ $data->leave_type }}
                            <input type="hidden" name="leave_type[]" value="{{ $data->id }}">
                        </td>
                        <td><input type="number" class="form-control leaves" name="leaves[]" value="0" min="0" max="365"
                                width="auto">
                        </td>
                        @endforeach
                    </tr>
