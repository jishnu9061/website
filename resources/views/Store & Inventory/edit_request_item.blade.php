                        ...
                        <div class="col-md-4">
                            <div class="mb-1">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="user_request" id="username" style="width:100%;">
                        ...
                        <div class="col-md-4">
                            <div class="mb-1">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="branch" id="username" style="width:100%;">
                                        <option>---select--- </option>
                                        <option>name 1 </option>
                                        <option>name 2</option>
                                        <option>name 3</option>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-sm">
                            ...
                            <table class="table table-striped table-class" id="tab_logic">
                                ...
                                <tbody>
                                    <tr>
                                        <td><select class="form-select" aria-label="select example" name="item_name[]"
                                                id="item_name">
                                        ...
                                        <td><button type="button" class="add-Row ibtnDel btn btn-primary text-white "
