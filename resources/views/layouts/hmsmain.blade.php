...
<head>
    ...
    {{-- sweet alert script ref:https://sweetalert2.github.io/ --}}
...
<body>
    ...
    <div id="app" style="background-color: #1d1d50;">
        <nav class=" newstyle1 navbar navbar-expand-lg  sticky-top navbar-light "
            style="background-color: #D5BD94;height:75px">
            ...
            <div class="logo" class="logo" style="*/background-color:#dfc79d;
                ...
                <a href="{{url('home')}}">
                    <img id="cr_logo" src="{{asset('/') }}/images/logo/{{ $copmany_name_for_sidebar->company_logo }}"
                        alt="CRA" style="margin-top:8px;height:auto;width:60px;">
                </a>
            </div>
            <div class="toggler p-2"
                style="text-align:center;height:auto;width:auto;color:#1D1D50;padding-left:10px;padding-top:10px;line-height: 150%; ">
            ...
            <div class="nav-item">
                <a id="das-" type="button" onclick="hideee()" class="nav-link"> <span
                        style=" color: #15144d;font-size: 30px;">☰</span></a>
            </div>
            <div class="nav-item">
                <a id="t" type="button" onclick="textsize()" class="nav-link"> <i class="fa fa-text-width"
                        style=" color: #15144d;font-size: 20px;"></i></a>
            </div>
            <div class="p-1" id="hgh"
                style="border: solid #a38931 1px; border-radius:5px; background-color:rgb(243, 238, 226);display:none;">
            ...
            <div class="nav-item dropdown" style="position: relative;">
                <button class=" dropdown-toggle-x btn  px-2 py-1 m-1" href="#" id="navbarDropdown" role="button"
            ...
            <div class="nav-item dropdown m-1" style="position: relative; ">
                <button class=" dropdown-toggle-x btn p-1" style="font-size:12px;" href="#" id="navbarDropdown"
            ...
            <div style="text-align: center;padding-left:1rem; ">
                ...
                <div class="display-time" style="height: 30.481482px;width:70.481482px;margin: auto;">
                </div>
            ...
            <div>
                <div class="stopwatch">
                    <h8 id="displayWatch" style="border:1px solid black; padding:4px;  border-radius: 8px;">00:00:00</h8>
                    ...
                    <a type="button" style="background: transparent;padding: 0px;margin: 0px;" onclick="openNav()"
                        ...
                        <div style="height: 50px;width:50px;border-radius:50%;background:#dfdfe4;">
                            <img src="{{asset('/') }}/images/faces/{{ Auth::user()->photo_path }}"
                                ...
                                style="-webkit-border-radius: 50%;height: 45px;width: 45px;margin-left:2.5px;margin-top:2.5px;"
                                alt="">
                        </div>
                    </a>
                </li>
    ...
    <div id="main"
        style="padding-bottom:8px;padding-top: 2px;padding-right: 15px;margin-right:-8px;background-color: #1D1D50;margin-top:5px;">
        {{-- mian start --}}
        <style>
        .display-date {
            text-align: center;
    ...
    function limitPagging() {
        ...
        if ($('.pagination li').length > 10) {
            ...
            if ($('.pagination li.active').attr('data-page') > 9) {
                ...
                $('.pagination [data-page="next"]').show();
                for (
                    let i = parseInt($('.pagination li.active').attr('data-page')) - 4; i <= parseInt($(
                        '.pagination li.active').attr('data-page')) + 4; i++
                ) {
