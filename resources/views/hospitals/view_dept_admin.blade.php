            ...
            <tbody>
                @foreach($dept_admin as $admin)
                    <tr class="table table-hover">
                        ...
                        <td>{{$admin->address}}</td>
                        <td>{{$admin->email}}</td>
                        <td><a href="{{url('detailpatient'.$admin->id)}}"><i class="fas fa-tasks"></i></a></td>
                        <td><a href="{{url('appointment'.$admin->id)}}"><i class="fas fa-eye"></i></a></td>
                        <td><a href="{{url('cross_consult'.$admin->id)}}"><i class="fas fa-exchange"></i></a></td>
                        <td><a href="{{url('editpatient'.$admin->id)}}"><i class="fas fa-edit"></i></a></td>
                    </tr>
                @endforeach
            </tbody>
        </table>
