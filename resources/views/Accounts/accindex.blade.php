...
<!-------------------------------------------new-------------------------------------------------------------------- -->
    ...
    <br>   
    <div class="row sm"> 
         <div class="col-sm-4"> <a href="{{ url('i_p_bank_bal') }}"><img class="logo_size"src="assets\image\Expense Report.png" alt=""><button type="button" style="width:70%;"class="btn btn-primary btn_align_btn">i/p Bank Balance</button></a></div>
    ...
    <br>   
    <div class="row sm"> 
        <div class="col-sm-4"> <a href="{{ url('profitandlossaccount') }}"><img class="logo_size"src="assets\image\Profit & loss.png" alt=""><button type="button" style="width:70%;" class="btn btn-primary btn_align_btn">Income & Expenditure Statement</button></a></div>
