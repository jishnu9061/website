...
<nav style="font-size:17px;">
    ...
    <a href="#" style="color: #1D1D50;">Income And Expenditure Statement</a>
</nav>
<br><br>
...
<table class="table table-striped">
    <tr>
    <th colspan="5" class="text-center"> <h5 class="manufacturing_heading"></h5><h5>PROFIT & LOSS ACCOUNT</h5></th>
    </tr>
    <tr>
        <th colspan="5">
