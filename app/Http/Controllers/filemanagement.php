...
public function editsafemanagement($id)
{
...
public function updatesafemanagement(Request $request)
{
...
{
    $delete_management=DB::table('cra_new_safe_management')->where('id',$id)->delete();
