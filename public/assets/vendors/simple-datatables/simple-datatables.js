    ...
    return (function() {
        ...
        1: [function(require, module, exports) {
            (function(global) {
                ...
                function createCommonjsModule(t, n) { return t(n = { exports: {} }, n.exports), n.exports }
                var dayjs_min = createCommonjsModule(function(t, n) {
                        t.exports = function() {
                            var t = "millisecond",
                                ...
                                d = {
                                    ...
                                    p: function(h) { return { M: o, y: u, w: s, d: i, h: r, m: e, s: n, ms: t, Q: a }[h] || String(h || "").toLowerCase().replace(/s$/, "") },
                                ...
                                $ = {};
                            $[m] = l;
                            var M = function(t) { return t instanceof v },
                                D = function(t, n, e) {
                                    var r;
                                    if (!t) return m;
                                ...
                                y = function(t, n, e) { if (M(t)) return t.clone(); var r = n ? "string" == typeof n ? { format: n, pl: e } : n : {}; return r.date = t, new v(r) },
                                g = d;
                            g.l = D, g.i = M, g.w = function(t, n) { return y(t, { locale: n.$L, utc: n.$u }) };
                            var v = function() {
                                function c(t) { this.$L = this.$L || D(t.locale, null, !0), this.parse(t) }
                                var d = c.prototype;
                                return d.parse = function(t) {
                                ...
                                }, d.$utils = function() { return g }, d.isValid = function() { return !("Invalid Date" === this.$d.toString()) }, d.isSame = function(t, n) { var e = y(t); return this.startOf(n) <= e && e <= this.endOf(n) }, d.isAfter = function(t, n) { return y(t) < this.startOf(n) }, d.isBefore = function(t, n) { return this.endOf(n) < y(t) }, d.$g = function(t, n, e) { return g.u(t) ? this[n] : this.set(e, t) }, d.year = function(t) { return this.$g(t, "$y", u) }, d.month = function(t) { return this.$g(t, "$M", o) }, d.day = function(t) { return this.$g(t, "$W", i) }, d.date = function(t) { return this.$g(t, "$D", "date") }, d.hour = function(t) { return this.$g(t, "$H", r) }, d.minute = function(t) { return this.$g(t, "$m", e) }, d.second = function(t) { return this.$g(t, "$s", n) }, d.millisecond = function(n) { return this.$g(n, "$ms", t) }, d.unix = function() { return Math.floor(this.valueOf() / 1e3) }, d.valueOf = function() { return this.$d.getTime() }, d.startOf = function(t, a) {
                                    var h = this,
                                        f = !!g.u(a) || a,
                                        c = g.p(t),
                                        d = function(t, n) { var e = g.w(h.$u ? Date.UTC(h.$y, n, t) : new Date(h.$y, n, t), h); return f ? e : e.endOf(i) },
                                        l = function(t, n) { return g.w(h.toDate()[t].apply(h.toDate(), (f ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(n)), h) },
                                        m = this.$W,
                                        $ = this.$M,
                                        M = this.$D,
                                        D = "set" + (this.$u ? "UTC" : "");
                                ...
                                }, d.endOf = function(t) { return this.startOf(t, !1) }, d.$set = function(s, a) {
                                    var h, f = g.p(s),
                                        c = "set" + (this.$u ? "UTC" : ""),
                                ...
                                }, d.set = function(t, n) { return this.clone().$set(t, n) }, d.get = function(t) { return this[g.p(t)]() }, d.add = function(t, a) {
                                    var h, f = this;
                                    t = Number(t);
                                    var c = g.p(a),
                                        d = function(n) { var e = y(f); return g.w(e.date(e.date() + Math.round(n * t)), f) };
                                    ...
                                    var e = t || "YYYY-MM-DDTHH:mm:ssZ",
                                        ...
                                        l = i.meridiem || function(t, n, e) { var r = t < 12 ? "AM" : "PM"; return e ? r.toLowerCase() : r },
                                    ...
                                    return e.replace(f, function(t, n) { return n || m[t] || r.replace(":", "") })
                                ...
                                }, d.daysInMonth = function() { return this.endOf(o).$D }, d.$locale = function() { return $[this.$L] }, d.locale = function(t, n) { if (!t) return this.$L; var e = this.clone(); return e.$L = D(t, n, !0), e }, d.clone = function() { return g.w(this.toDate(), this) }, d.toDate = function() { return new Date(this.$d) }, d.toJSON = function() { return this.isValid() ? this.toISOString() : null }, d.toISOString = function() { return this.$d.toISOString() }, d.toString = function() { return this.$d.toUTCString() }, c
                            }();
                            return y.prototype = v.prototype, y.extend = function(t, n) { return t(n, v, y), y }, y.locale = D, y.isDayjs = M, y.unix = function(t) { return y(1e3 * t) }, y.en = $[m], y.Ls = $, y
                        }()
                    }),
                    customParseFormat = createCommonjsModule(function(t, n) {
                        ...
                        t.exports = (r = /(\[[^[]*\])|([-:\/.()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g, o = /\d*[^\s\d-:\/.()]+/, u = [/[+-]\d\d:?\d\d/, function(t) {
                            ...
                            A: [/[AP]M/, function(t) { this.afternoon = "PM" === t }],
                            a: [/[ap]m/, function(t) { this.afternoon = "pm" === t }],
                            S: [/\d/, function(t) { this.milliseconds = 100 * +t }],
                            SS: [i = /\d\d/, function(t) { this.milliseconds = 10 * +t }],
                            SSS: [/\d{3}/, function(t) { this.milliseconds = +t }],
                            s: [s = /\d\d?/, (a = function(t) { return function(n) { this[t] = +n } })("seconds")],
                            ss: [s, a("seconds")],
                            m: [s, a("minutes")],
                            mm: [s, a("minutes")],
                            H: [s, a("hours")],
                            ...
                            MMM: [o, function(t) {
                                var n = e,
                                    r = n.months,
                                    i = n.monthsShort,
                                    s = i ? i.findIndex(function(n) { return n === t }) : r.findIndex(function(n) { return n.substr(0, 3) === t });
                            ...
                            Y: [/[+-]?\d+/, a("year")],
                            YY: [i, function(t) { t = +t, this.year = t + (t > 68 ? 1900 : 2e3) }],
                            YYYY: [/\d{4}/, a("year")],
                            Z: u,
                            ZZ: u
                        }, f = function(t, n, e) {
        ...
        2: [function(require, module, exports) {
            ...
            const isObject = t => "[object Object]" === Object.prototype.toString.call(t),
                isJson = t => { let e = !1; try { e = JSON.parse(t) } catch (t) { return !1 } return !(null === e || !Array.isArray(e) && !isObject(e)) && e },
                createElement = (t, e) => {
                ...
                flush = t => { t instanceof NodeList ? t.forEach(t => flush(t)) : t.innerHTML = "" },
            ...
            class Columns {
                ...
                order(t) {
                    ...
                    const h = [
                        ...
                        o = this.dt;
                    t.forEach((t, a) => { n = o.headings[t], l = "false" !== n.getAttribute("data-sortable"), (e = n.cloneNode(!0)).originalCellIndex = a, e.sortable = l, h[0].push(e), o.hiddenColumns.includes(t) || ((s = n.cloneNode(!0)).originalCellIndex = a, s.sortable = l, h[1].push(s)) }), o.data.forEach((e, s) => {
                ...
                sort(t, e, s) {
                    ...
                    if ("date" === d.getAttribute("data-type")) {
                        let t = !1;
                        d.hasAttribute("data-format") && (t = d.getAttribute("data-format")), c.push(new Promise(function(t) { t(require("./date-4abbfef1.js")) }).then(({ parseDate: e }) => s => e(s, t)))
                    }
                    Promise.all(c).then(i => {
                        ...
                        const g = [];
                        n.forEach((t, e) => { a.data.push(t.row), null !== t.row.searchIndex && void 0 !== t.row.searchIndex && g.push(e) }), a.searchData = g, this.rebuild(), a.update(), s || a.emit("datatable.sort", t, e)
                    })
                }
                rebuild() {
                    let t, e, s, a;
                    const i = this.dt,
                        n = [];
                    i.activeRows = [], i.activeHeadings = [], i.headings.forEach((t, e) => { t.originalCellIndex = e, t.sortable = "false" !== t.getAttribute("data-sortable"), i.hiddenColumns.includes(e) || i.activeHeadings.push(t) }), i.data.forEach((l, r) => {
            ...
            const dataToTable = function(t) {
                ...
                defaultConfig = { sortable: !0, searchable: !0, paging: !0, perPage: 10, perPageSelect: [5, 10, 15, 20, 25], nextPrev: !0, firstLast: !1, prevText: "&lsaquo;", nextText: "&rsaquo;", firstText: "&laquo;", lastText: "&raquo;", ellipsisText: "&hellip;", ascText: "▴", descText: "▾", truncatePager: !0, pagerDelta: 2, scrollY: "", fixedColumns: !0, fixedHeight: !1, header: !0, footer: !1, labels: { placeholder: "Search...", perPage: "{select}", noRows: "No entries found", info: "Showing {start} to {end} of {rows} entries" }, layout: { top: "{select}{search}", bottom: "{info}{pager}" } };
            class DataTable {
                constructor(t, e = {}) {
                ...
                init(t) {
                    ...
                    Object.assign(this.options, t || {}), this.currentPage = 1, this.onFirstPage = !0, this.hiddenColumns = [], this.columnRenderers = [], this.selectedColumns = [], this.render(), setTimeout(() => { this.emit("datatable.init"), this.initialized = !0, this.options.plugins && Object.entries(this.options.plugins).forEach(([t, e]) => { this[t] && "function" == typeof this[t] && (this[t] = this[t](e, { createElement: createElement }), e.enabled && this[t].init && "function" == typeof this[t].init && this[t].init()) }) }, 10)
                }
                render(t) {
                    if (t) {
                        switch (t) {
                    ...
                    if (e.data && dataToTable.call(this), e.ajax) {
                        const t = e.ajax,
                            ...
                            a = t => { this.emit("datatable.ajax.progress", t, s) },
                            i = e => {
                                if (4 === s.readyState)
                            ...
                            n = t => { this.emit("datatable.ajax.error", t, s) },
                            l = t => { this.emit("datatable.ajax.abort", t, s) };
                    ...
                    if (this.body = this.table.tBodies[0], this.head = this.table.tHead, this.foot = this.table.tFoot, this.body || (this.body = createElement("tbody"), this.table.appendChild(this.body)), this.hasRows = this.body.rows.length > 0, !this.head) {
                        const t = createElement("thead"),
                            s = createElement("tr");
                        this.hasRows && (Array.from(this.body.rows[0].cells).forEach(() => { s.appendChild(createElement("th")) }), t.appendChild(s)), this.head = t, this.table.insertBefore(this.head, this.body), this.hiddenHeader = !e.ajax
                    }
                ...
                renderPager() {
                    if (flush(this.pagers), this.totalPages > 1) {
                        ...
                        let i = this.links;
                        this.options.truncatePager && (i = truncate(this.links, this.currentPage, this.pages.length, this.options.pagerDelta, this.options.ellipsisText)), this.links[this.currentPage - 1].classList.add("active"), i.forEach(t => { t.classList.remove("active"), e.appendChild(t) }), this.links[this.currentPage - 1].classList.add("active"), this.options.nextPrev && e.appendChild(button(t, a, this.options.nextText)), this.options.firstLast && e.appendChild(button(t, this.totalPages, this.options.lastText)), this.pagers.forEach(t => { t.appendChild(e.cloneNode(!0)) })
                    }
                }
                renderHeader() {
                ...
                setColumns(t) {
                    ...
                    }), this.hasRows && (this.data.forEach((t, e) => { t.dataIndex = e, Array.from(t.cells).forEach(t => { t.data = t.innerHTML }) }), this.selectedColumns.length && this.data.forEach(t => { Array.from(t.cells).forEach((e, s) => { this.selectedColumns.includes(s) && this.columnRenderers.forEach(a => { a.columns.includes(s) && (e.innerHTML = a.renderer.call(this, e.data, e, t)) }) }) }), this.columns().rebuild()), this.render("header")
                }
                destroy() { this.table.innerHTML = this.initialLayout, this.table.classList.remove("dataTable-table"), this.wrapper.parentNode.replaceChild(this.table, this.wrapper), this.initialized = !1 }
                update() {
                ...
                paginate() { const t = this.options.perPage; let e = this.activeRows; return this.searching && (e = [], this.searchData.forEach(t => e.push(this.activeRows[t]))), this.options.paging ? this.pages = e.map((s, a) => a % t == 0 ? e.slice(a, a + t) : null).filter(t => t) : this.pages = [e], this.totalPages = this.lastPage = this.pages.length, this.totalPages }
                fixColumns() {
                    if ((this.options.scrollY.length || this.options.fixedColumns) && this.activeHeadings && this.activeHeadings.length) {
                        let t, e = !1;
                        if (this.columnWidths = [], this.table.tHead) {
                            if (this.options.scrollY.length && ((e = createElement("thead")).appendChild(createElement("tr")), e.style.height = "0px", this.headerTable && (this.table.tHead = this.headerTable.tHead)), this.activeHeadings.forEach(t => { t.style.width = "" }), this.activeHeadings.forEach((t, s) => {
                            ...
                            }), this.data.forEach(t => { Array.from(t.cells).forEach((t, e) => { this.columns(t.cellIndex).visible() && (t.style.width = `${a[e]}%`) }) }), this.table.removeChild(e)
                        }
                    }
                }
                    ...
                    return !!this.hasRows && (t = t.toLowerCase(), this.currentPage = 1, this.searching = !0, this.searchData = [], t.length ? (this.clear(), this.data.forEach((e, s) => {
                        ...
                        t.split(" ").reduce((t, s) => {
                            ...
                            for (let t = 0; t < e.cells.length; t++)
                                if ((n = (i = e.cells[t]).hasAttribute("data-content") ? i.getAttribute("data-content") : i.textContent).toLowerCase().includes(s) && this.columns(i.cellIndex).visible()) { a = !0; break }
                            return t && a
                ...
                clear(t) {
                    ...
                    if (this.body || (e = this.table), t) {
                        if ("string" == typeof t) { document.createDocumentFragment().innerHTML = t }
                        e.appendChild(t)
                    }
                }
                export (t) {
                    ...
                    if (s.data.length || isObject(s.data)) {
                        if ("csv" === s.type) {
                            ...
                            t.length && (s.headings && (e.headings = t[0].split(s.columnDelimiter), t.shift()), t.forEach((t, a) => {
                                ...
                                i.length && i.forEach(t => { e.data[a].push(t) })
                            }))
                        } else if ("json" === s.type) {
                            const t = isJson(s.data);
                            t && (e = { headings: [], data: [] }, t.forEach((t, s) => { e.data[s] = [], Object.entries(t).forEach(([t, a]) => { e.headings.includes(t) || e.headings.push(t), e.data[s].push(a) }) }))
                        }
                ...
                print() {
                    const t = this.activeHeadings,
                        ...
                        n = createElement("tr");
                    t.forEach(t => { n.appendChild(createElement("th", { html: t.textContent })) }), a.appendChild(n), e.forEach(t => {
                        const e = createElement("tr");
                        Array.from(t.cells).forEach(t => { e.appendChild(createElement("td", { html: t.textContent })) }), i.appendChild(e)
                ...
                columns(t) { return new Columns(this, t) }
                rows(t) { return new Rows(this, t) }
