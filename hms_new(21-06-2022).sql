...
(17, NULL, 'pharmacy2', NULL, NULL, '2022-06-20 04:51:38', 'kims intetrnational'),
(18, '37', 'dsdsd', NULL, NULL, '2022-06-20 05:29:27', 'kims intetrnational'),
(19, '0', 'ssASas', NULL, NULL, '2022-06-20 05:30:10', 'kims intetrnational'),
(20, 'Pharmacy', 'pharmacy1', NULL, NULL, '2022-06-20 05:48:39', 'kims intetrnational');
...
CREATE TABLE `pharmacy_sub_dept` (
  `phar_sub_deptid` int(11) NOT NULL,
...
ALTER TABLE `pharmacy_sub_dept`
  ADD PRIMARY KEY (`phar_sub_deptid`);
...
--
ALTER TABLE `pharmacy_sub_dept`
  MODIFY `phar_sub_deptid` int(11) NOT NULL AUTO_INCREMENT;
