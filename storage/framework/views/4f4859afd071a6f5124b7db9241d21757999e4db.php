        ...
        <div class="modal fade" id="myModal">
            <div class="modal-dialog modal-sm">
              ...
              <div class="modal-body">
                    <div class="container">
                        <form method="post" action="<?php echo e(url('create_generic')); ?>">
                            <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-md-12">
...
<div class="tab-content" id="myTabContent">
    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
            ...
            <table class="table table-bordered" id="allsupplier">
                ...
                <tbody>
                         <?php $__currentLoopData = $generic_name; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                         <tr id="data">
                            <td class="text-center"><?php echo e($data->id); ?></td>
                            <td class="text-center" id="generic_name_x"><?php echo e($data->generic_name); ?></td>
                              <input type="hidden" value="<?php echo e($data->id); ?>" id="generic_hidden" class="applicate" name="brand_id_hidden">
                            <td class="text-center"><a href="<?php echo e(url('update_generic'.$data->id)); ?>" class="edits" data-toggle="modal" id="edit_generic" data-bs-toggle="modal"
                                data-bs-target="#edit"><i class="fas fa-edit" style="color:#435ebe;"></i></a></td>
                            <td class="text-center"><a  onClick="return myFunction();" href="<?php echo e(url('delete_generic'.$data->id)); ?>" style="color:#435ebe;"><i class="fas fa-trash-alt"></i></a></td>
                         </tr>
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
      <div class="modal-content">
        ...
        <form method="POST" enctype="multipart/form-data" action="<?php echo e(url('update_generic')); ?>" >
          <?php echo csrf_field(); ?>
        <div class="modal-body">
            <div class="container">
                <div class="row">
...
<?php echo $__env->make('layouts.hmsmain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp-globaleyet\resources\views/store/generic_name_views.blade.php ENDPATH**/ ?>