...
<br>
<div class="container">
    <h3 style="text-align:center"><b><u>Purchase Details</u></b></h3><br>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td style="width:20%"><select class="form-control" aria-label="Default select example" name="manufacturer" disabled>
                                        ...
                                        <?php $__currentLoopData = $manufact; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($key->id); ?>" <?php echo e(($key->id == $data->id) ? "selected" : ""); ?> > <?php echo e($key->manufactuers_name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                      </select></td>
                                    <td style="width:20%"> <input type="date" name="purchase_date"  value="<?php echo e($data->purchase_date); ?>"class="form-control" readonly></td>
                                    <td style="width:20%"><input type="text" name="purchase_number" value="<?php echo e($data->purchase_orderno); ?>" class="form-control" style="pointer-events: none;" readonly></td>
                                  </tr>
                                  <tr>
                                    <thead>
                                        <tr>
                                  ...
                                  <tr>
                                    ...
                                    <td scope="col"><select class="form-select" aria-label="Default select example" name="payment_type" disabled>
                                        <option value="">Select</option>
                                    ...
                                    <td scope="col"><select class="form-select" aria-label="Default select example" name="supplier" disabled>
                                        <option value="">Select</option>
                                        <?php $__currentLoopData = $supplier; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($key->id); ?>" <?php echo e(($key->id == $data->id) ? "selected" : ""); ?> > <?php echo e($key->supplier_name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                      </select></td>
                                    <td scope="col"><select class="form-select" aria-label="Default select example" name="status" disabled>
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <input type="hidden" name="item_id[]" value="<?php echo e($row->id); ?>"class="form-control">
                                        <tr>
                                            <td>
                                                <select class="form-select" aria-label="select example"  name="item_name[]" id="item_name" disabled>
                                                    <option value="">Select</option>
                                            ...
                                            <td><input type="text" name="batch_no[]" id="batch_no" class="form-control" value="<?php echo e($row->batch_no); ?>" disabled></td>
                                            <td><input type="text" name="quantity[]" id="quantity" class="form-control  calculate"  value="<?php echo e($row->quantity); ?>" disabled></td>
                                            <td><input type="text" name="price[]" id="price" class="form-control calculate"  value="<?php echo e($row->price); ?>" disabled></td>
                                            <td><input type="text" name="total[]" id="total" class="form-control calculate-sub" value="<?php echo e($row->total); ?>" disabled></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.hmsmain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp-globaleyet\resources\views/store/purchase_detailes_view.blade.php ENDPATH**/ ?>