...
<body>
    <div id="app">
      ...
      <div class="" style="height: 50px;border: 1px solid grey;border-radius: 10px;padding-top: 8px; background-color: black;">
        <div class="row">
            <div class="col-md-3">
                  <h5 style="color: red;text-align: center;">Department: <?php echo e($dep); ?></h5> 
            </div>
            <div class="col-md-5">
                <h5 style="color: red;text-align: center;" id="ct6"></h5> 
            </div>
            <div class="col-md-4">
                <h5 style="color: red;text-align: center;">Total Que: <?php echo e($quecount); ?></h5> 
            </div>
        </div>
    ...
    <h4 style="color:#ececec;text-align: center;"><?php echo e($doctor->name); ?></h4> 
    </div>
    <div  style="height: 105px;border: 1px solid grey;border-radius: 10px;padding:0;padding-top: 8px; background-color: black;">
    
    <h1 style="color: red;text-align: center;padding-top: 15px;"><?php echo e($doctor->serve); ?></h1> 
...
<?php endfor; ?>
 ...
 <div class="row" style="padding-left:15px;padding-right: 15px;">
	   ...
	   <?php $__currentLoopData = $depqueue; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $queue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    
    <div class="col-md-1" style="height: 105px;border: 1px solid grey;border-radius: 10px;padding-top: 8px; background-color: black;" >
	
	<h4 style="color: red;text-align: center;"><?php echo e($queue->token); ?></h4> 
    </div>
		<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php 
        $var=60-$quecount;
...
<?php /**PATH C:\xampp\htdocs\multi-hospital\resources\views/doctor/depqueue.blade.php ENDPATH**/ ?>