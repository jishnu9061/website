            ...
            <table id="example1" class="table table-bordered table-striped" style="width 100%">
              <thead>
                ...
                <tbody  id="show_data">
                  ...
                  <input type="hidden" name="purchase_id" value="<?php echo e($row->request_intendid); ?>" class="form-control">
                    <tr>
                      <td  class="text-center"><?php echo e($row->Item_name); ?></td>
                      <td  class="text-center"><?php echo e($row->requested_quantity); ?></td>
                      <td  scope="row"class="text-center"> <a type="button"  href="<?php echo e(url('store_issued_items'.$row->medicine)); ?>"class="btn btn-primary" style="background-color:#1a3c62;width:100%;">Issue</a></td>
                    </tr>
...
<?php echo $__env->make('layouts.hmsmain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\erp-globaleyet\resources\views/store/department_requested_items.blade.php ENDPATH**/ ?>