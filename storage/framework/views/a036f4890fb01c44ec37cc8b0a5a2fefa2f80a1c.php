        ...
        <div class="modal fade" id="myModal">
            <div class="modal-dialog modal-lg">
              ...
              <div class="modal-body">
                <div class="container">
                    <form method="post" action="<?php echo e(url('add_manufacturers')); ?>">
                        <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="col-md-12">
...
<div class="tab-content" id="myTabContent">
    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
            ...
            <table class="table table-bordered" id="allsupplier">
                ...
                <tbody>
                    <?php $__currentLoopData = $manufacturers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr id="data">
                            <td  scope="row" class="text-center"><?php echo e($data->id); ?></td>
                            <td  scope="row" class="text-center" id="manfact_name_x"><?php echo e($data->manufactuers_name); ?></td>
                            <td  scope="row"class="text-center" id="manufact_mobile"><?php echo e($data->mobile); ?></td>
                            <td  scope="row"class="text-center"><a href="<?php echo e(url('view_manufacturer_details'.$data->id)); ?>"><i  style="color:#435ebe;" class="fa fa-eye" aria-hidden="true"></i></td>
                            <input type="hidden" value="<?php echo e($data->id); ?>" id="manfact_hidden" class="applicate" name="supplier_id_hidden">
                            <td class="text-center"><a href="<?php echo e(url('update_manufacturer'.$data->id)); ?>" class="edits" data-toggle="modal" id="sup_edit_manufactuer" data-bs-toggle="modal"
                                data-bs-target="#edit"><i class="fas fa-edit" style="color:#435ebe;"></i></a></td>
                            <td class="text-center"><a  onClick="return myFunction();" href="<?php echo e(url('delete_manufacturer'.$data->id)); ?>" style="color:#435ebe;"><i class="fas fa-trash-alt"></i></a></td>
                            <td  class="text-center"> <a type="button" class="btn btn-primary" style="width:50%" href="<?php echo e(url('manufacturer_ledger_details'.$data->id)); ?>"><b>View</b></a></td>
                            <input type="hidden" id="manfact_email" value="<?php echo e($data->email); ?>">
                            <input type="hidden" id="manfact_phone" value="<?php echo e($data->contact_no); ?>">
                            <input type="hidden" id="manfact_mobile" value="<?php echo e($data->mobile); ?>">
                            <input type="hidden" id="manfact_fax" value="<?php echo e($data->fax); ?>">
                            <input type="hidden" id="manfact_address" value="<?php echo e($data->address); ?>">
                            <input type="hidden" id="manfact_city" value="<?php echo e($data->city); ?>">
                            <input type="hidden" id="manfact_state" value="<?php echo e($data->state); ?>">
                            <input type="hidden" id="manfact_country" value="<?php echo e($data->country); ?>">
                            <input type="hidden" id="manfact_postal_code" value="<?php echo e($data->zipcode); ?>">
                            <input type="hidden" id="manufact_details" value="<?php echo e($data->details); ?>">
                        </tr>
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <form method="POST" enctype="multipart/form-data" action="<?php echo e(url('update_manufacturer')); ?>">
          <?php echo csrf_field(); ?>
        <div class="modal-body">
            <div class="container">
                <div class="row">
...
<?php echo $__env->make('layouts.hmsmain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\erp-globaleyet\resources\views/store/view_manufactuers.blade.php ENDPATH**/ ?>