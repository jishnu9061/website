...
<table class="table table-hover " id="allpatients" style="margin-top: 40px;  ">
  ...
  <tbody style="background-color:white;">
    <?php $no=1; ?>
 <?php $__currentLoopData = $ambulance; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $amb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr class="product_data" id="data">
        <td><?php echo $no++;?></td>
          <td id="name"><?php echo e($amb->vehicle_name); ?></td>
          <td id="model"><?php echo e($amb->vehicle_model); ?></td>
          <td id="year"><?php echo e($amb->year_made); ?></td>
          <td id="drname"><?php echo e($amb->driver_name); ?></td>
          <td id="licence"><?php echo e($amb->driver_license); ?></td>
          <td id="contact"><?php echo e($amb->driver_contact); ?></td> 
          <td id="type"><?php echo e($amb->vehicle_type); ?></td>
          ...
          <td id=amb_status> <?php if($amb->status==1)
            ...
            ?>
               ...
               <input type="hidden" id="amb_id" value="<?php echo e($amb->id); ?>" name="">
               <td><a href="#" class="edits" data-toggle="modal" id="amb_edit" data-bs-toggle="modal"
                   data-bs-target="#edit"><i class="fas fa-edit"></i></a></td>
                   <td><a href="<?php echo e(url('delete_ambulance'.$amb->id)); ?>"><i class="fas fa-trash-alt"></i></a></td>
      </tr>
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <h5 class="modal-title bb" id="myModalLabel1">Add Ambulance </h5>
                                     ...
                                     <form action="<?php echo e(url('saveamb_details')); ?>" method="post" > 
                                     <?php echo csrf_field(); ?>
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <h5 class="modal-title bb" id="myModalLabel1">edit Ambulance </h5>
                                     ...
                                     <form action="<?php echo e(url('update_details')); ?>" method="post" > 
                                     <?php echo csrf_field(); ?>
                                    <div class="modal-body">
...
<?php echo $__env->make('layouts.hmsmain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\multi-hospital\resources\views/ambulance/amb_view.blade.php ENDPATH**/ ?>