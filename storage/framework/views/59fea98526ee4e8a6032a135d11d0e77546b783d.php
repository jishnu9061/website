      ...
      <div class="row card-row">
        <div class="wrapper-left">
          <div class="card_wrap">
            ...
            <?php if($order->total_stock > 0): ?>
            <div class="box">
              <div class="box-inner">
                
                <h3 style="color:rgb(5, 82, 5);"><b><?php echo e($order->Item_name); ?></b></h3>
                <h1 style="color:rgb(5, 82, 5);"><b><?php echo e($order->total_stock); ?></b></h1>
              </div>
            </div>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.hmsmain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp-globaleyet\resources\views/store/reorder_level.blade.php ENDPATH**/ ?>