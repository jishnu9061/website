                        ...
                        <div class="row">
                            <div class="col-sm">
                                ...
                                <select class="form-select" aria-label="Default select example" name="manufacturer">
                                    ...
                                    <?php $__currentLoopData = $manufact; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($key->id); ?>"><?php echo e($key->manufactuers_name); ?></option>
                            ...
                            <div class="col-sm">
                                    <label for="">Purchase Order Number</label>
                                     <input type="text" name="purchase_number" id="purchase_number" class="form-control" value="<?php if(!empty($purc_order->purchase_orderno)): ?><?php echo e($purc_order->purchase_orderno); ?><?php else: ?><?php echo e(strtoupper(uniqid())); ?><?php endif; ?>"><br>
                            </div>
                        </div>
                          <div class="row">
                            <div class="col-sm">
                                <label for="">Payment Type</label>
                                        <select class="form-select" aria-label="Default select example" id="payment_type" name="payment_type" required>
                                            ...
                                            <?php $__currentLoopData = $payment_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                             <option value="<?php echo e($key1->payment_id); ?>"><?php echo e($key1->payment_name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                            </div>
                            <div class="col-sm">
                            ...
                            <div class="col-sm">
                                ...
                                <input type="text" value=<?php echo e('Order-Placed'); ?> name="status" id="purchase_date" class="form-control" readonly><br>
                            </div>
                            </div>
                            <br>
                                ...
                                <div class="row clearfix">
                                            ...
                                            <tr>
                                                <td><select class="form-select"  aria-label="select example" name="item_name[]" id="item_name">
                                                    ...
                                                    <?php $__currentLoopData = $item_name; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($row->id); ?>"><?php echo e($row->Item_name); ?>--<?php echo e($row->brand_name); ?>--<?php echo e($row->category_name); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                  </select></td>
                                  ...
                                  <div class="modal fade" id="myModal-2">
                                    <div class="modal-dialog modal-xm">
                                      ...
                                      <div class="modal-body">
                                        <div class="container">
                                            <form method="post" action="<?php echo e(url('add_advance_pyment')); ?>" enctype="multipart/form-data">
                ...
                <tbody>
                    <?php $__currentLoopData = $purc_order; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr id="data">
                            ...
                            <td  scope="row" class="text-center"><?php echo e(date('d-m-Y',strtotime($data->purchase_date))); ?></td>
                            ...
                            <td  scope="row" class="text-center" id="sup_name_x"><?php echo e($data->status); ?></td>
                            <td  scope="row"class="text-center"><a href="<?php echo e(url('purchase_detailes_view'.$data->id)); ?>"><i  style="color:#435ebe;" class="fa fa-eye" aria-hidden="true"></i></td>
                            <td><a href="<?php echo e(url('edit_purchase_detailes'.$data->id)); ?>"><i  style="color:#435ebe;" class="fa fa-edit" aria-hidden="true"></i></td>
...
<div class="modal fade" id="myModal-1">
    <div class="modal-dialog modal-xl">
      ...
      <div class="modal-body">
        <div class="container">
            <form method="post" action="<?php echo e(url('create_purchase_medicine')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="row">
                    <div class="col-sm">
...
<?php echo $__env->make('layouts.hmsmain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp-globaleyet\resources\views/store/view_received_detailes.blade.php ENDPATH**/ ?>