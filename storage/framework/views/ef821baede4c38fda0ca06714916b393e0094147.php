...
?>
 <?php $__currentLoopData = $ledger_account; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exp_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr class="product_data" class="data">
          ...
          <td><?php echo e($exp_type->budget_name); ?></td>
          <td id="expanse_status"><?php echo e($exp_type->accounts_desc); ?></td>
               ...
               <td>
                ...
                <a href="#" class="edits"    data-toggle="modal" id="amb_edit" data-bs-toggle="modal"
                   data-bs-target="#edit"><i class="fas fa-edit" onclick="values_edit(`<?php echo e($exp_type->id); ?>`,`<?php echo e($exp_type->category_id); ?>`,`<?php echo e($exp_type->subcategory_id); ?>`,`<?php echo e($exp_type->accounts_name); ?>`,`<?php echo e($exp_type->accounts_desc); ?>`,'<?php echo e($exp_type->budget_id); ?>');" >
                       </i></a>
              ...
              <form action="<?php echo e(url('save_ledger_acounts')); ?>" method="post" >
                        ...
                        <div class="form-group mb-3">
                           ...
                           <select class="form-control" name="budget_cat" id="budget_cat"  required>
                               <option value=""> Select</option>
                               <?php $__currentLoopData = $budget_cat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $budget): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>:
...
<?php echo $__env->make('layouts.hmsmain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\cra_project\CRA\resources\views/Accounts/index.blade.php ENDPATH**/ ?>