...
$.ajaxSetup({
    ...
    $.ajax({
    url:"<?php echo e(route('get_total_number_of_item')); ?>",
    type:"POST",
    data: {
        item: value,
    },
...
if ($("#journal_form")[0].checkValidity()){
       ...
       // $('#creating_btn').show();
        ...
        $.ajaxSetup({
            ...
            $.ajax({
            url:"<?php echo e(route('create_new_stock_issue')); ?>", 
            type:"POST",
            data: {
...
<?php echo $__env->make('layouts.hmsmain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp-globaleyet\resources\views/Accounts/stock_issue.blade.php ENDPATH**/ ?>