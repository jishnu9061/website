                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                      ...
                      <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                 <li class="submenu-item ">
                                    <a href="<?php echo e(url('hospitals')); ?>">Add hospitals</a>
                                </li>

                                <li class="submenu-item ">
                                    <a href="<?php echo e(url('admins')); ?>">Add Admins</a>
                                </li>

                                 <li class="submenu-item ">
                                    <a href="<?php echo e(url('allhospitals')); ?>">All hospitals</a>
                                </li>
                      ...
                      <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu">
                                 <li class="submenu-item">
                                    <a href="<?php echo e(url('addstaffs')); ?>">Add Staffs</a>
                                </li>
                                 <li class="submenu-item">
                                    <a href="<?php echo e(url('staffs')); ?>">All staffs</a>
                                </li>
                         ...
                         <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu">
                                 <li class="submenu-item">
                                    <a href="<?php echo e(url('addsalary')); ?>">Add salary</a>
                                </li>
                                 <li class="submenu-item">
                                    <a href="<?php echo e(url('addallowance')); ?>">Add allowance</a>
                                </li>
                           ...
                           <?php endif; ?> -->
                        <?php $__currentLoopData = $key; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <li class="sidebar-item">
                            <a href="<?php echo e(url($k->previlages)); ?>" class='sidebar-link'>
                                <i class="bi bi-grid-fill"></i>
                                <span><?php echo e(ucfirst($k->previlages)); ?></span>
                            </a>
                        </li>
...
<i class="fa-regular fa-user"  style="font-weight: 300;"></i>
                            ...
                            <ul class="submenu" style=";">
                             ...
                             <a href="<?php echo e(url('usermanagement')); ?>" class='sidebar-link'>
                                ...
                                <li class="submenu-item ">
                                <a href="<?php echo e(url('adddepartmentadmin')); ?>" class='sidebar-link'>

                                <span>Add Department Admin</span>
                            </a>
                                </li>
                                <li class="submenu-item ">
                                <a href="<?php echo e(url('addroomstypes')); ?>" class='sidebar-link'>

                                <span>Add Room Types</span>
                            </a>
                                </li>
                                <li class="submenu-item ">
                                <a href="<?php echo e(url('addroomtypes')); ?>" class='sidebar-link'>

                                <span>Add Rooms</span>
                            </a>
                                </li>
                                <li class="submenu-item ">
                                <a href="<?php echo e(url('beds')); ?>" class='sidebar-link'>

                                <span>Room Management</span>
                            </a>
                                </li>
                                <li class="submenu-item ">
                                <a href="<?php echo e(url('Add_Ambulance_details')); ?>" class='sidebar-link'>
                            ...
                            <?php if(Auth::user()->role == 'lab'|| Auth::user()->role == 'hospitaladmin'): ?>
                            <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu" style="display: none;">
                                <li class="submenu-item ">
                                <a href="<?php echo e(url('labcategory')); ?>" class='sidebar-link'>

                                <span>Lab Category</span>
                            </a>
                                </li>
                                <li class="submenu-item ">
                                <a href="<?php echo e(url('labtests')); ?>" class='sidebar-link'>

                                <span>Lab Tests</span>
                            </a>
                                </li>
                                <li class="submenu-item ">
                                <a href="<?php echo e(url('labprofile')); ?>" class='sidebar-link'>

                                <span>Lab Profile</span>
                            </a>
                                </li>
                                <li class="submenu-item ">
                                <a href="<?php echo e(url('patlabtest')); ?>" class='sidebar-link'>

                                <span>Patient's Lab test</span>
                            </a>
                                </li>
                                <li class="submenu-item ">
                                <a href="<?php echo e(url('alllabtestsview')); ?>" class='sidebar-link'>
                           ...
                           <a href="<?php echo e(url('home')); ?>" class='sidebar-link'>
                            ...
                            <ul class="submenu" style="display: block;">
                                ...
                                <li class="submenu-item ">
                                <!-- <a href="<?php echo e(url('manualattendance')); ?>" class='sidebar-link'>

                                <span>Manual Attendance</span>
                            </a> -->
                                </li>
                                <li class="submenu-item ">
                                <a href="<?php echo e(url('payslipbulk')); ?>" class='sidebar-link'>
                     ...
                     <i class="fa fa-chart-line" style="font-weight: 400;"></i>
                           ...
                           <?php endif; ?>
                             ...
                             <?php if(Auth::user()->role == 'Doctor'|| Auth::user()->role == 'hospitaladmin'): ?>
                             <li class="sidebar-item  has-sub">
                        <a href="<?php echo e(url('home')); ?>" class='sidebar-link'>
                        <i class="fa fa-stethoscope" style="font-weight: 400;"></i>
                            ...
                            <ul class="submenu" style="display: none;">
                                <li class="submenu-item ">
                                <a href="<?php echo e(url('Consultation')); ?>" class='sidebar-link'>

                                <span>Consultation</span>
                            </a>
                                </li>
                                <li class="submenu-item ">
                                <a href="<?php echo e(url('todaysappointments')); ?>" class='sidebar-link'>

                                <span>Today's Appointments</span>
                            </a>
                                </li>
                                <li class="submenu-item ">
                                <a href="<?php echo e(url('reappointments')); ?>" class='sidebar-link'>

                                <span>Re Apppointments</span>
                            </a>
                                </li>
                                <li class="submenu-item ">
                                <a href="<?php echo e(url('allpatients')); ?>" class='sidebar-link'>
                                ...
                                <li class="submenu-item ">
                                <a href="<?php echo e(url('depqueue')); ?>" class='sidebar-link'>
                                ...
                                <li class="submenu-item ">
                                <a href="<?php echo e(url('dutyschedulefetch')); ?>" class='sidebar-link'>
                                ...
                                <li class="submenu-item ">
                                <a href="<?php echo e(url('applyleave')); ?>" class='sidebar-link'>
                           ...
                           <?php if(Auth::user()->role == 'casuality'|| Auth::user()->role == 'hospitaladmin'): ?>
                              <li class="sidebar-item  has-sub">
<a href="<?php echo e(url('home')); ?>" class='sidebar-link'>
  <i class="bi bi-grid-fill"></i>
  <span>Casuality</span>
...
<ul class="submenu" style="display: none;">
  ...
  <li class="submenu-item ">
  <a href="<?php echo e(url('casuality_patient')); ?>" class='sidebar-link'>

     <span>Add Casualities</span>
 </a>
  </li>
  <li class="submenu-item ">
  <a href="<?php echo e(url('all_catualitypatients')); ?>" class='sidebar-link'>
  ...
  <li class="submenu-item ">
  <a href="<?php echo e(url('ambulance_details')); ?>" class='sidebar-link'>
  ...
  <a href="<?php echo e(url('beds')); ?>" class='sidebar-link'>
      ...
      <span>Room Management</span>
                          ...
                          <?php if(Auth::user()->role == 'pharma'|| Auth::user()->role == 'hospitaladmin'): ?>
                          <li class="sidebar-item  has-sub">
                          <a href="<?php echo e(url('home')); ?>" class='sidebar-link'>
                          <i class="fa fa-book-medical " style="font-weight: 400;"></i>
                            ...
                            <ul class="submenu" style="display: none;">
                                <li class="submenu-item ">
                                <a href="<?php echo e(url('serving')); ?>" class='sidebar-link'>
                                ...
                                <li class="submenu-item ">
                                <a href="<?php echo e(url('manage_biils')); ?>" class='sidebar-link'>

                                <span>Billing</span>
                            </a>
                                </li>
                                <li class="submenu-item ">
                                <a href="<?php echo e(url('allmedicinez')); ?>" class='sidebar-link'>
                                ...
                                <li class="submenu-item ">
                               <a href="<?php echo e(url('addmedicines')); ?>" class='sidebar-link'>
                                ...
                                <li class="submenu-item ">
                                <a href="<?php echo e(url('alldoctors')); ?>" class='sidebar-link'>
                                <span>Doctors</span>
                            </a>
                            ...
                            <a href="<?php echo e(url('reorder')); ?>" class='sidebar-link'>

                                <span>Reorder</span>
                            </a>
                                </li>
                                <li class="submenu-item ">
                                <a href="<?php echo e(url('expired')); ?>" class='sidebar-link'>

                                <span>Expired Items</span>
                            </a>
                                </li>
                                <li class="submenu-item ">
                                <a href="<?php echo e(url('request_items')); ?>" class='sidebar-link'>
                           ...
                           <?php endif; ?>
                         <?php if(Auth::user()->role == 'counter'|| Auth::user()->role == 'hospitaladmin'): ?>
                         <li class="sidebar-item  has-sub">
<a href="<?php echo e(url('home')); ?>" class='sidebar-link'>
       <i class="bi bi-grid-fill"></i>
       <span>Counter</span>
   ...
   <ul class="submenu" style="display: none;">
       <li class="submenu-item ">
       <a href="<?php echo e(url('counter')); ?>" class='sidebar-link'>

       <span>Counter</span>
    </a>
       </li>
       <li class="submenu-item ">
       <a href="<?php echo e(url('todaysappointmentsall')); ?>" class='sidebar-link'>

       <span>Today's Appointments</span>
   </a>
       </li>
       <li class="submenu-item ">
       <a href="<?php echo e(url('appointment')); ?>" class='sidebar-link'>
       ...
       <span>All Patients</span>
         ...
         <li class="submenu-item ">
         <a href="<?php echo e(url('patientregistration')); ?>" class='sidebar-link'>

       <span>Patientregistration</span>
   </a>
       </li>
       <li class="submenu-item ">
       <a href="<?php echo e(url('patientinsurance')); ?>" class='sidebar-link'>
       ...
       <span>Patient Insurance</span>
                        ...
                        <a href="<?php echo e(url('home')); ?>" class='sidebar-link'>
                            ...
                            <ul class="submenu" style="display: none;">
                                <li class="submenu-item ">
                                <a href="<?php echo e(url('depstaffs')); ?>" class='sidebar-link'>

                                <span>Staffs</span>
                             </a>
                                </li>
                                <li class="submenu-item ">
                                <a href="<?php echo e(url('depstock')); ?>" class='sidebar-link'>
                                ...
                                <li class="submenu-item ">
                                <a href="<?php echo e(url('depbeds')); ?>" class='sidebar-link'>

                                <span>Beds</span>
                             </a>
                                </li>
                                <li class="submenu-item ">
                                <a href="<?php echo e(url('deppats')); ?>" class='sidebar-link'>

                                <span>Patients</span>
                             </a>
                                </li>
                                 <li class="submenu-item ">
                                 <a href="<?php echo e(url('depleaves')); ?>" class='sidebar-link'>
                           ...
                           <?php if(Auth::user()->role == 'nurse'|| Auth::user()->role == 'hospitaladmin'): ?>
                           ...
                           <i class="bi bi-shop"  ></i>
                            ...
                            <ul class="submenu" style="display: none;">
                                ...
                                <a href="#" class="sidebar-link">
                                       ...
                                       <ul class="submenu" style="display: none;">
                                        <li class="submenu-item ">
                                            <a href="<?php echo e(url('view_medicine')); ?>" >All Medicines</a>
                                        </li>

                                           <li class="submenu-item ">
                                               <a href="<?php echo e(url('view_medicine_category')); ?>">Category</a>
                                           </li>
                                           <li class="submenu-item ">
                                               <a href="<?php echo e(url('view_medicine_type')); ?>">Medicine Type</a>
                                           </li>
                                           <li class="submenu-item ">
                                            <a href="<?php echo e(url('view_unit')); ?>">Unit</a>
                                            </li>
                                            <li class="submenu-item ">
                                                <a href="<?php echo e(url('view_medicine_group')); ?>">Medicine Groups</a>
                                                </li>
                                            <li class="submenu-item ">
                                                <a href="<?php echo e(url('view_brand_name')); ?>">Brand name</a>
                                            </li>
                                            <li class="submenu-item ">
                                                    <a href="<?php echo e(url('view_generic_name')); ?>">Generic name</a>
                                            </li>
...
<li class="submenu-item ">
                            ...
                            <li class="submenu-item   has-sub">
                            <a href="<?php echo e(url('stock_details')); ?>" class='sidebar-link'>
                           ...
                           <li class="sidebar-item  has-sub">
                                  ...
                                  <span>Settings</span>
                                       ...
                                       <ul class="submenu" style="display: none;">
                                        <li class="submenu-item ">
                                        <a href="<?php echo e(url('payment_type')); ?>">Payment Type</a>
                                        </li>
</ul>
                                ...
                                <a href="<?php echo e(url('view_request')); ?>" class='sidebar-link'>
                                 ...
                                 <li class="submenu-item   has-sub">
                                 <a href="<?php echo e(url('serveitems')); ?>" class='sidebar-link'>
                                ...
                                <a href="<?php echo e(url('view_request')); ?>" class='sidebar-link'>
                                 ...
                                 <a href="<?php echo e(url('serveitems')); ?>" class='sidebar-link'>
                                   ...
                                   <span>All Medicines</span>
                                    ...
                                    <li class="submenu-item  has-sub">
                                    <a href="<?php echo e(url('pharma_orders')); ?>" class='sidebar-link'>
   ...
   <!--
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                 <li class="submenu-item ">
                                    <a href="<?php echo e(url('allpatients')); ?>">All Patients</a>
                                </li>
                                <li class="submenu-item ">
                                    <a href="<?php echo e(url('patientregistration')); ?>">Patient registration</a>
                                </li>
                                <li class="submenu-item ">
                                    <a href="<?php echo e(url('patientinsurance')); ?>">Patient Insurance</a>
                                </li>
                                <li class="submenu-item ">
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                <li class="submenu-item ">
                                    <a href="<?php echo e(url('queuemanagement')); ?>">Queue management</a>
                                </li>
                                <li class="submenu-item ">
                                    <a href="<?php echo e(url('appointment')); ?>">Appoinment </a>
                                </li>
                                <li class="submenu-item ">
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                   <?php if(Auth::user()->role == 'hospitaladmin'): ?>
                                <li class="submenu-item ">
                                    <a href="<?php echo e(url('allocatebedsandrooms')); ?>">Allocate Bed & Room</a>
                                </li>
                                   <?php endif; ?>
                                <li class="submenu-item ">
                                    <a href="<?php echo e(url('beds')); ?>"> Bed & Room</a>
                                </li>
                                <li class="submenu-item ">
                                ...
                                <li class="submenu-item ">
                                    <a href="<?php echo e(url('billing')); ?>"> Billing & Summary</a>
                                </li>
                            </ul>
                        </li> -->
...
<!--
        ...
        <div id="main">
            ...
            <div class="page-heading">
                <h3 style="color:#c30147;"><?php echo e(Auth::user()->Hospital); ?></h3>
...
<?php /**PATH C:\xampp\htdocs\erp-globaleyet\resources\views/layouts/attendancelayout.blade.php ENDPATH**/ ?>