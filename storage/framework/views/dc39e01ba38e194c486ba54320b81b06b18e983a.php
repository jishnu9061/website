        ...
        <div class="col-md-12">
         <table class="table table-striped mt-5" id="debit_table">
             ...
             <tr >
                ...
                <td width="15%">
                    <input type="number"  onchange="calculation_function()" id="quantity-select" class="form-control">
                </td>


                <td  width="15%"><input type="text" onchange="calculation_function()"  id="rate-select" class="form-control"></td>
                <td  width="15%"><input type="text" id="total-select" class="form-control"></td>
      ...
      htmlRows += '<tr class="itemRow" id="debit_row_'+count+'">';
        ...
        htmlRows +='<option value="3">Finished Goods</option>';
         ...
         htmlRows += '<td><select class="form-control" required  name="item[]" id="stock_item_select_'+count+'" >';
            ...
            htmlRows +='<option value="<?php echo $acc->id  ?>"><?php echo e($acc->stock_items_itemcode."--".$acc->stock_items_name." [ ".$acc->stock_categories_name."--".$acc->stock_subcategories_name." ] "); ?></option>';
            <?php endforeach; ?>
             htmlRows += '</select></td>';
         ...
         htmlRows += '<td><input type="text" class="form-control total_amnt" readonly onchange="total_credit_amount()" name="credit_amount[]" id="total_select_'+count+'"></td>';
...
$("input[name^='reciept_rate[]']").each(function(index){
    reciept_rate.push($(this).val());
});
...
if ($("#journal_form")[0].checkValidity()){
        ...
        $.ajaxSetup({
            ...
            $.ajax({
            url:"<?php echo e(route('create_new_stock_transaction')); ?>",
            type:"POST",
            data: {
...
function save_ledger_account(){
    ...
    if ($("#account_form")[0].checkValidity()){
                    ...
                    $.ajaxSetup({
                        ...
                        $.ajax({
                        url:"<?php echo e(route('create_new_ledger_account')); ?>",
                        type:"POST",
                        data: {
...
<?php echo $__env->make('layouts.hmsmain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp-globaleyet\resources\views/Accounts/stock_selection.blade.php ENDPATH**/ ?>