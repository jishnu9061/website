             ...
             <tr >
                ...
                <select class="form-control"  id="debit-from-select">
                    ...
                    <?php $__currentLoopData = $account; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $acc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>:
                     <option value="<?php echo e($acc->id); ?>"> <?php echo e($acc->accounts_name." [ ".$acc->ledgeraccount_categories." ] "); ?></option>
          ...
          .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajaxSetup({
                    ...
                    $.ajax({
                    url:"<?php echo e(route('create_new_journal')); ?>",
                    type:"POST",
                    data: {
...
<?php echo $__env->make('layouts.hmsmain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp-globaleyet\resources\views/Accounts/new_transaction.blade.php ENDPATH**/ ?>