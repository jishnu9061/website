...
<table class="table table-hover" id="allpatients" style="margin-top: 40px;">
 ...
 <?php $__currentLoopData = $labprofiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr class="product_data" id="data">
          <td id="name"><?php echo e($lab->id); ?></td>
          <td id="labnamex"><?php echo e($lab->name); ?></td> 
          ...
          <td><a href="<?php echo e(url('dellabprof'.$lab->name)); ?>"><i class="fas fa-trash-alt"></i></a></td>
      </tr>
  ...
  <div class="modal fade text-left" id="default" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                   ...
                                   <form action="<?php echo e(url('labprofile')); ?>" method="post"> 
                                     <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.hmsmain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\multi-hospital\resources\views/lab/labprofile.blade.php ENDPATH**/ ?>