    ...
    <h2> Balance</h2>
      ...
      <div class="table-responsive">
          ...
          <table class="table table-striped table">
              <tr>
                  <form method="post" action="<?php echo e(url("balancesheet")); ?>">
                      <?php echo csrf_field(); ?>
                  <td>From Date</td>
...
<table class="table table-striped">
    <tr>
    <th colspan="3"> <h5 class="text-center">BALANCE</h5></th>
    </tr>
    <tr>
        <th colspan="3">
...
<?php echo $__env->make('layouts.hmsmain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp-globaleyet\resources\views/Accounts/balance_sheet.blade.php ENDPATH**/ ?>