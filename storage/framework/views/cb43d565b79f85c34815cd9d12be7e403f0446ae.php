...
<table class="table table-striped" id="allpatients" style="margin-top: 40px;">
 ...
 <?php $__currentLoopData = $labcat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr class="product_data" id="data">
          <td id="name"><?php echo e($lab->id); ?></td>
          <td id="model"><?php echo e($lab->name); ?></td>
               ...
               <td><a href="#" class="edits" data-toggle="modal" id="amb_edit" data-bs-toggle="modal"
                   ...
                   <td><a href="<?php echo e(url('dellabcat'.$lab->id)); ?>"><i class="fas fa-trash-alt"></i></a></td>
      </tr>
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <h5 class="modal-title bb" id="myModalLabel1">Add Lab Category </h5>
                                     ...
                                     <form action="<?php echo e(url('labcategory')); ?>" method="post" > 
                                     <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.hmsmain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\multi-hospital\resources\views/lab/labcategory.blade.php ENDPATH**/ ?>