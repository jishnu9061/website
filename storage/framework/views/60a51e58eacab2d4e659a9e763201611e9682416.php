...
<link href="<?php echo e(url('assets/css')); ?>/select2.min.css" rel="stylesheet" />
...
<div class="container">
<form method="post" action="<?php echo e(url('store_ledger')); ?>">
    <?php echo csrf_field(); ?>
...
<td><select class="form-control"  name="transaction_group_select" required  onchange="apply_group_result_item(this.value)" id="transaction-group-select">
    ...
    <option value="<?php echo e($group->id); ?>" <?php echo e(($group->id==$transaction_group_select) ? "selected":""); ?> > <?php echo e($group->stock_groups_name); ?> </option>
...
<td>
    <select class="custom-select2 form-control select2-hidden-accessible select2_function"  required style="width: 100%; height: 38px;"
     ...
     <?php if(!empty($item_select_options)): ?>
    <?php $__currentLoopData = $item_select_options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

    <option value="<?php echo e($val->id); ?>" <?php echo e(($val->id==$item_select) ? "selected":""); ?>> <?php echo e($val->stock_items_itemcode."--".$val->stock_items_name."-[".$val->stock_categories_name."--".$val->stock_subcategories_name."]"); ?></option>
...
<tr>
<td>FROM DATE</td>
<td> <input class="form-control" name="from_date" value="<?php echo e($from_date); ?>" required type="date"> </td>
<td>TO DATE</td>
<td><input class="form-control" name="to_date" value="<?php echo e($to_date); ?>" required type="date"> </td>
</tr>
<tr>
    <td colspan="3"></td>
...
<table class="table table-striped" style="margin-top: 40px; ">
    ...
    <tbody>
     <?php $__currentLoopData = $opening_values; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
     ...
     ?>
        ...
        <?php
            $no=1;
                ...
                $balamount=0;
        ?>
        <?php $__currentLoopData = $ledger_datas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
         <tr>
            <td><?php echo e($no++); ?></td>
           <td><?php echo e($row->transaction_id); ?></td>


           <td><?php echo e(date('d M Y',strtotime($row->tranaction_date))); ?></td>
           <td>[<?php echo e($row->stock_items_itemcode); ?>]<br>
               <?php echo e($row->stock_items_name); ?><br>
              [ <?php echo e($row->stock_groups_name); ?>]
            </td>
           <td><?php echo e(($row->stock_transaction_type==1)? "RECIEPT" :"ISSUE"); ?>


           </td>

           <td><?php echo e($row->receipt_qty); ?>


           </td>

           <td><?php echo e($row->receipt_rate); ?></td>
           <td><?php echo e($row->receipt_amount); ?></td>

           <td><?php echo e($row->issue_qty); ?></td>
           <td><?php echo e($row->issue_rate); ?></td>

           <td><?php echo e($row->issue_amount); ?></td>

           <td><?php echo e($row->balance_qty); ?></td>
           <td><?php echo e($row->balance_rate); ?></td>
           <td><?php echo e($row->balance_amount); ?></td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
       


        <?php $__currentLoopData = $closing_values; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  ...
  <div class="modal fade text-left" id="default" tabindex="-1" role="dialog"
     ...
     <button type="button" class="close rounded-pill" data-bs-dismiss="modal" aria-label="Close">
         <i data-feather="x"></i>
              ...
              <form action="<?php echo e(url('save_stock_categories')); ?>" method="post" >
                                     <?php echo csrf_field(); ?>
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <h5 class="modal-title bb" id="myModalLabel1">Edit Group</h5>
                                     ...
                                     <form action="<?php echo e(url('update_stock_categories')); ?>" method="post" >
                                     <?php echo csrf_field(); ?>
                                    <div class="modal-body">
 ...
 <script src="<?php echo e(url('assets/js')); ?>/select2.min.js" defer></script>
  ...
  <script>
    function apply_group_result_item(value){
        ...
        $.ajaxSetup({
            ...
            $.ajax({
            url:"<?php echo e(route('get_item_with_group')); ?>",
            type:"POST",
            data: {
                group: value,
            },
          ...
          .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajaxSetup({
                    ...
                    $.ajax({
                    url:"<?php echo e(route('delete_stock_category')); ?>",
                    type:"POST",
                    data: {
                        id: value,
...
<?php echo $__env->make('layouts.hmsmain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp-globaleyet\resources\views/Accounts/fifo_store_ledger.blade.php ENDPATH**/ ?>