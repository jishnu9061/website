                ...
                <tbody>
                    <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="table table-hover" id="data1">
                            ...
                            <input type="hidden" value="<?php echo e($data->id); ?>" id="department_id" class="applicate"
                                name="department_id">
                            ...
                            <td><a onClick="return myFunction();" href="<?php echo e(url('delete_department' . $data->id)); ?>"><i
...
<?php echo $__env->make('layouts.hmsmain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp-globaleyet\resources\views/hospitals/adddepartments.blade.php ENDPATH**/ ?>