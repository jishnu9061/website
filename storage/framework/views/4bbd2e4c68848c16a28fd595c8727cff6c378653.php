...
<div class="page-heading">
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>View All Departments Admin</h3>
    ...
    <section class="section">
        <table class="table table-striped table-bordered" id="mydatatable">
            ...
            <tbody>
                <?php $__currentLoopData = $dept_admin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $admin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="table table-hover">
                        <td><?php echo e($admin->id); ?></td>
                        <td><?php echo e($admin->firstname); ?></td>
                        <td><?php echo e($admin->phoneno); ?></td>
                        <td><?php echo e($admin->address); ?></td>
                        <td><?php echo e($admin->email); ?></td>
                        <td><a href="<?php echo e(url('detailpatient'.$admin->id)); ?>"><i class="fas fa-tasks"></i></a></td>
                        <td><a href="<?php echo e(url('appointment'.$admin->id)); ?>"><i class="fas fa-eye"></i></a></td>
                        <td><a href="<?php echo e(url('cross_consult'.$admin->id)); ?>"><i class="fas fa-exchange"></i></a></td>
                        <td><a href="<?php echo e(url('editpatient'.$admin->id)); ?>"><i class="fas fa-edit"></i></a></td>
                    </tr>
...
<?php echo $__env->make('layouts.hmsmain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\multi-hospital\resources\views/hospitals/view_dept_admin.blade.php ENDPATH**/ ?>