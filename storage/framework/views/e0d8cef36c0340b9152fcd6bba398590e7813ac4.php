...
<table class="table table-hover" id="allpatients" style="margin-top: 40px;">
  ...
  <tbody>
    ...
    <tr class="product_data" id="data">
      ...
      <td id="firstname"><?php echo e($patient->firstname); ?></td>
      <td id="paddress"><?php echo e($patient->address); ?></td>
      <td id="p_age"><?php echo e($patient->age); ?></td>
      <td id="pphoneno"><?php echo e($patient->phoneno); ?></td>
      <td id="pDepartment"><?php echo e($patient->Department); ?></td>
      <td><?php echo e($patient->bystander_name.'['.$patient->contact_no.']'); ?></td>
      <input type="hidden" id="p_id" value="<?php echo e($patient->id); ?>" name="">
      ...
      <td><a href="<?php echo e(url('view_cltypatient'.$patient->id)); ?>"><i class="fas fa-eye"></i></a></td>
      <td><a href="<?php echo e(url('casuality_billing'.$patient->id)); ?>"><i class="fa fa-file-pdf"></i></a></td>
    </tr>
...
<?php echo $__env->make('layouts.hmsmain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\multi-hospital\resources\views/casuality/allpatients.blade.php ENDPATH**/ ?>