...
$no=1;
?>
 <?php $__currentLoopData = $stock_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ledcat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <input type="hidden" id="id" value="<?php echo e($ledcat->id); ?>" name="">
               <td>
                ...
                <a href="#" class="edits"    data-toggle="modal" id="amb_edit" data-bs-toggle="modal"
                   data-bs-target="#edit"><i class="fas fa-edit" onclick="values_edit(`<?php echo e($ledcat->id); ?>`,`<?php echo e($ledcat->stock_categories_name); ?>`);" >
                </i></a>
...
<?php echo $__env->make('layouts.hmsmain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp-globaleyet\resources\views/Accounts/stock_categories.blade.php ENDPATH**/ ?>