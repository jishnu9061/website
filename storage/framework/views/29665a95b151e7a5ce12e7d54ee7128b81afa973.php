    ...
    <div>
        <div class="container">
            ...
            <?php $__currentLoopData = $ledger_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <form action="<?php echo e(url('add_installment_details' . $row->purchase_id)); ?>" method="post"
                            ...
                            <div class="card-body">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a type="button" class="btn btn-primary" style="background-color:#607080;width:20%;"
                                        href="<?php echo e(url('supplier_ledger_details' . $row->purchase_id)); ?>"><b>Close</b></a>
                                    <button type="submit" class="btn btn-primary refresh-button" id="button"
                                        style="background-color:#607080;width:20%;"
                                        href="<?php echo e(url('supplier_ledger_details' . $row->purchase_id)); ?>">Save</button>
                                </div>
                            </div>
                            <br>
...
<?php echo $__env->make('layouts.hmsmain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp-globaleyet\resources\views/store/update_amount.blade.php ENDPATH**/ ?>