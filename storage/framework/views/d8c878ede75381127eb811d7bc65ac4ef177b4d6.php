...
<ul class="nav nav-tabs" id="myTab" role="tablist">
  <li class="nav-item" role="presentation">
    ...
    <li class="nav-item" role="presentation">
    <a class="nav-link" id="profile-tab" data-bs-toggle="tab" href="#reductions" role="tab" aria-controls="profile" aria-selected="false">Deductions</a>
  </li>
  <li class="nav-item" role="presentation">
...
<div class="row">
	<div class="col-md-6 col-lg-6">
	    ...
	    <table class="table table-bordered">
			...
			<tbody >
				...
				<tr class="allowdatax">
					<td class="allownamex"><?php echo e($data->allowancename); ?></td>
					<td class="allowpricex"><?php echo e($data->price); ?></td>
					<td class="allowpercentx"><?php echo e($data->percent); ?></td>
					<input type="hidden" class="allowidx" value="<?php echo e($data->id); ?>">
					...
					<form method="post" action="<?php echo e(url('allowancedelete'.$data->id)); ?>">
					<?php echo csrf_field(); ?>
	...
	<div class="col-md-6 col-lg-6">
	    ...
	    <table class="table table-bordered">
			...
			<tbody >
				<?php $__currentLoopData = $nondata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<tr class="allowdatax">
					<td class="allownamex"><?php echo e($data->allowancename); ?></td>
					<!-- <td class="allowpricex"><?php echo e($data->price); ?></td> -->
					<input type="hidden" class="allowidx" value="<?php echo e($data->id); ?>">
...
<div class="tab-pane fade" id="reductions" role="tabpanel" aria-labelledby="profile-tab">
...
<div style="height: 50px;">
	...
	<div class="container">
		...
		<table class="table table-bordered">
			...
			<tbody>
				<?php $__currentLoopData = $reductiondata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<tr id="deddat">
					<td id="rednametd"><?php echo e($data->allowancename); ?></td>
					<td id="redpricetd"><?php echo e($data->price); ?></td>
					<td id="redpercenttd"><?php echo e($data->percent); ?></td>
                    <input type="hidden" value="<?php echo e($data->id); ?>" id="redidtd">
					...
					<form method="post" action="<?php echo e(url('reductiondelete'.$data->id)); ?>">
					<?php echo csrf_field(); ?>
					<input type="hidden" name="delete">
...
<div class="container">
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr id="levdat">
                <td id="levdattyp"><?php echo e($data->leave_type); ?></td>
                <td id="levdatabr"><?php echo e($data->abbreviation); ?></td>
                ...
                <form method="post" action="<?php echo e(url('leavetypedelete'.$data->id)); ?>">
                <?php echo csrf_field(); ?>
                <input type="hidden" value="<?php echo e($data->id); ?>" id="fnduniqid" name="delete">
                <td><button type="submit" onclick="return confirm('Are you sure?')" class="fa fa-trash"></button></td>
                </form>
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<div class="tab-content" id="myTabContent">
 <div class="tab-pane fade show active" id="fixd" role="tabpanel" aria-labelledby="home-tab">
 	   ...
 	   <form action="<?php echo e(url('addallowance')); ?>" method="post" >
                                     <?php echo csrf_field(); ?>
 ...
 <form action="<?php echo e(url('addnonfixedallowance')); ?>" method="post" >
                                     <?php echo csrf_field(); ?>
                                    <div class="modal-body">
                              <div class="card-body">
                        <div class="form-group mb-3">
 ...
 <!--  Reduction Add Modal -->
 	   ...
 	   <form action="<?php echo e(url('addreduction')); ?>" method="post" >
                                     <?php echo csrf_field(); ?>
                                    <div class="modal-body">
...
<form action="<?php echo e(url('addleavetype')); ?>" method="post" >
                   <?php echo csrf_field(); ?>
                  <div class="modal-body">
...
<!--  Allowance Edit Modal -->
  <div class="modal fade text-left" id="default" tabindex="-1" role="dialog"
    ...
    <h5 class="modal-title bb" id="myModalLabel1"> </h5>
                                     ...
                                     <form action="<?php echo e(url('editdeallowance')); ?>" method="post" >
                                     <?php echo csrf_field(); ?>
                                    <div class="modal-body">
    ...
    <h5 class="modal-title bb" id="myModalLabel1"> </h5>
                                     ...
                                     <form action="<?php echo e(url('editdereduction')); ?>" method="post" >
                                     <?php echo csrf_field(); ?>
                                    <div class="modal-body">
...
<div class="modal fade text-left" id="editleave" tabindex="-1" role="dialog"
         ...
         <h5 class="modal-title bb" id="myModalLabel1"> </h5>
                                     ...
                                     <form action="<?php echo e(url('editleavetype')); ?>" method="post" >
                                     <?php echo csrf_field(); ?>
                                    <div class="modal-body">
...
<?php echo $__env->make('layouts.hmsmain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp-globaleyet\resources\views/add/addallowance.blade.php ENDPATH**/ ?>