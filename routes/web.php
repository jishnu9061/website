...
//file management controller
    ...
    Route::any('edit_incomming_letters/{id}', "filemanagement@editincommingletters")->name('edit_incomming_letters');
    Route::any('update_incomming_letters/{id}', "filemanagement@updateincommingletters")->name('update_incomming_letters');
    Route::any('delete_incomming_letters/{id}', "filemanagement@deleteincommingletter")->name('delete_incomming_letters');
